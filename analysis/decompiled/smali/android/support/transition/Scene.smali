...
.method public static getSceneForLayout(Landroid/view/ViewGroup;ILandroid/content/Context;)Landroid/support/transition/Scene;
    ...
    .prologue
    .line 62
    sget v4, Landroid/support/transition/R$id;->transition_scene_layoutid_cache:I
    ...
    .line 64
    .local v3, "scenes":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/support/transition/Scene;>;"
    if-nez v3, :cond_0

    .line 65
    new-instance v3, Landroid/util/SparseArray;

    .end local v3    # "scenes":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/support/transition/Scene;>;"
    invoke-direct {v3}, Landroid/util/SparseArray;-><init>()V

    .line 66
    .restart local v3    # "scenes":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/support/transition/Scene;>;"
    sget v4, Landroid/support/transition/R$id;->transition_scene_layoutid_cache:I
    ...
    .line 74
    .end local v1    # "scene":Landroid/support/transition/Scene;
    ...
    .end local v0    # "scene":Landroid/support/transition/Scene;
    .restart local v1    # "scene":Landroid/support/transition/Scene;
    move-object v2, v0
