...
.method public static getFieldType(Ljava/lang/Class;Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;
    ...
    .line 260
    .local v8, "genericArrayType":Ljava/lang/reflect/GenericArrayType;
    ...
    invoke-static {v0, v1, v4}, Lcom/alibaba/fastjson/util/FieldInfo;->getFieldType(Ljava/lang/Class;Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;

    move-result-object v5

    .line 262
    .local v5, "componentTypeX":Ljava/lang/reflect/Type;
    if-eq v4, v5, :cond_2
    ...
    .local v7, "fieldTypeX":Ljava/lang/reflect/Type;
    move-object/from16 v6, p2
    ...
    .end local v6    # "fieldType":Ljava/lang/reflect/Type;
    .end local v7    # "fieldTypeX":Ljava/lang/reflect/Type;
    .restart local p2    # "fieldType":Ljava/lang/reflect/Type;
    :cond_2
    move-object/from16 v6, p2
    ...
    .end local v5    # "componentTypeX":Ljava/lang/reflect/Type;
    .end local v6    # "fieldType":Ljava/lang/reflect/Type;
    .end local v8    # "genericArrayType":Ljava/lang/reflect/GenericArrayType;
    .restart local p2    # "fieldType":Ljava/lang/reflect/Type;
    :cond_3
    ...
    invoke-static {v10}, Lcom/alibaba/fastjson/util/TypeUtils;->getClass(Ljava/lang/reflect/Type;)Ljava/lang/Class;

    move-result-object v11

    .local v11, "parameterizedClass":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    ...
    .line 279
    .local v13, "typeVar":Ljava/lang/reflect/TypeVariable;, "Ljava/lang/reflect/TypeVariable<*>;"
    invoke-virtual {v11}, Ljava/lang/Class;->getTypeParameters()[Ljava/lang/reflect/TypeVariable;

    move-result-object v14

    .line 280
    .local v14, "typeVariables":[Ljava/lang/reflect/TypeVariable;, "[Ljava/lang/reflect/TypeVariable<*>;"
    const/4 v9, 0x0
    ...
    .end local v11    # "parameterizedClass":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    .end local v13    # "typeVar":Ljava/lang/reflect/TypeVariable;, "Ljava/lang/reflect/TypeVariable<*>;"
    .end local v14    # "typeVariables":[Ljava/lang/reflect/TypeVariable;, "[Ljava/lang/reflect/TypeVariable<*>;"
    :cond_6
    move-object/from16 v0, p2
    ...
    .line 291
    .local v12, "parameterizedFieldType":Ljava/lang/reflect/ParameterizedType;
    ...
    .line 305
    .restart local v14    # "typeVariables":[Ljava/lang/reflect/TypeVariable;, "[Ljava/lang/reflect/TypeVariable<*>;"
    :goto_2
    invoke-interface {v10}, Ljava/lang/reflect/ParameterizedType;->getActualTypeArguments()[Ljava/lang/reflect/Type;

    move-result-object v15

    invoke-static {v2, v14, v15}, Lcom/alibaba/fastjson/util/FieldInfo;->getArgument([Ljava/lang/reflect/Type;[Ljava/lang/reflect/TypeVariable;[Ljava/lang/reflect/Type;)Z
    ...
    invoke-direct {v0, v2, v15, v1}, Lcom/alibaba/fastjson/util/ParameterizedTypeImpl;-><init>([Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;)V
    ...
    instance-of v15, v15, Ljava/lang/reflect/ParameterizedType;
    ...
    .end local v10    # "paramType":Ljava/lang/reflect/ParameterizedType;
    .end local v12    # "parameterizedFieldType":Ljava/lang/reflect/ParameterizedType;
    .end local v14    # "typeVariables":[Ljava/lang/reflect/TypeVariable;, "[Ljava/lang/reflect/TypeVariable<*>;"
    :cond_9
    move-object/from16 v6, p2
