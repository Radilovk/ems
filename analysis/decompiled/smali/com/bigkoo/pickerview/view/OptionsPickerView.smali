...
.method private initView(Landroid/content/Context;)V
    ...
    .line 40
    iget-object v5, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->mPickerOptions:Lcom/bigkoo/pickerview/configure/PickerOptions;
    ...
    iget-object v6, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->mPickerOptions:Lcom/bigkoo/pickerview/configure/PickerOptions;

    iget v6, v6, Lcom/bigkoo/pickerview/configure/PickerOptions;->layoutRes:I

    iget-object v7, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->contentContainer:Landroid/view/ViewGroup;
    ...
    invoke-virtual {p0, v5}, Lcom/bigkoo/pickerview/view/OptionsPickerView;->findViewById(I)Landroid/view/View;
    ...
    .line 48
    .local v3, "rv_top_bar":Landroid/widget/RelativeLayout;
    ...
    .end local v3    # "rv_top_bar":Landroid/widget/RelativeLayout;
    .end local v4    # "tvTitle":Landroid/widget/TextView;
    :goto_3
    sget v5, Lcom/bigkoo/pickerview/R$id;->optionspicker:I
    ...
    .line 77
    .local v2, "optionsPicker":Landroid/widget/LinearLayout;
    iget-object v5, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->mPickerOptions:Lcom/bigkoo/pickerview/configure/PickerOptions;
    ...
    .line 79
    new-instance v5, Lcom/bigkoo/pickerview/view/WheelOptions;

    iget-object v6, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->mPickerOptions:Lcom/bigkoo/pickerview/configure/PickerOptions;

    iget-boolean v6, v6, Lcom/bigkoo/pickerview/configure/PickerOptions;->isRestoreItem:Z

    invoke-direct {v5, v2, v6}, Lcom/bigkoo/pickerview/view/WheelOptions;-><init>(Landroid/view/View;Z)V

    iput-object v5, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->wheelOptions:Lcom/bigkoo/pickerview/view/WheelOptions;

    .line 80
    iget-object v5, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->mPickerOptions:Lcom/bigkoo/pickerview/configure/PickerOptions;

    iget-object v5, v5, Lcom/bigkoo/pickerview/configure/PickerOptions;->optionsSelectChangeListener:Lcom/bigkoo/pickerview/listener/OnOptionsSelectChangeListener;

    if-eqz v5, :cond_0

    .line 81
    iget-object v5, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->wheelOptions:Lcom/bigkoo/pickerview/view/WheelOptions;

    iget-object v6, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->mPickerOptions:Lcom/bigkoo/pickerview/configure/PickerOptions;

    iget-object v6, v6, Lcom/bigkoo/pickerview/configure/PickerOptions;->optionsSelectChangeListener:Lcom/bigkoo/pickerview/listener/OnOptionsSelectChangeListener;

    invoke-virtual {v5, v6}, Lcom/bigkoo/pickerview/view/WheelOptions;->setOptionsSelectChangeListener(Lcom/bigkoo/pickerview/listener/OnOptionsSelectChangeListener;)V
    ...
    iget v6, v6, Lcom/bigkoo/pickerview/configure/PickerOptions;->textSizeContent:I

    invoke-virtual {v5, v6}, Lcom/bigkoo/pickerview/view/WheelOptions;->setTextContentSize(I)V
    ...
    iget-object v6, v6, Lcom/bigkoo/pickerview/configure/PickerOptions;->label1:Ljava/lang/String;

    iget-object v7, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->mPickerOptions:Lcom/bigkoo/pickerview/configure/PickerOptions;

    iget-object v7, v7, Lcom/bigkoo/pickerview/configure/PickerOptions;->label2:Ljava/lang/String;

    iget-object v8, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->mPickerOptions:Lcom/bigkoo/pickerview/configure/PickerOptions;

    iget-object v8, v8, Lcom/bigkoo/pickerview/configure/PickerOptions;->label3:Ljava/lang/String;

    invoke-virtual {v5, v6, v7, v8}, Lcom/bigkoo/pickerview/view/WheelOptions;->setLabels(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget v6, v6, Lcom/bigkoo/pickerview/configure/PickerOptions;->x_offset_one:I

    iget-object v7, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->mPickerOptions:Lcom/bigkoo/pickerview/configure/PickerOptions;

    iget v7, v7, Lcom/bigkoo/pickerview/configure/PickerOptions;->x_offset_two:I

    iget-object v8, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->mPickerOptions:Lcom/bigkoo/pickerview/configure/PickerOptions;

    iget v8, v8, Lcom/bigkoo/pickerview/configure/PickerOptions;->x_offset_three:I

    invoke-virtual {v5, v6, v7, v8}, Lcom/bigkoo/pickerview/view/WheelOptions;->setTextXOffset(III)V
    ...
    iget-boolean v6, v6, Lcom/bigkoo/pickerview/configure/PickerOptions;->cyclic1:Z

    iget-object v7, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->mPickerOptions:Lcom/bigkoo/pickerview/configure/PickerOptions;

    iget-boolean v7, v7, Lcom/bigkoo/pickerview/configure/PickerOptions;->cyclic2:Z

    iget-object v8, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->mPickerOptions:Lcom/bigkoo/pickerview/configure/PickerOptions;

    iget-boolean v8, v8, Lcom/bigkoo/pickerview/configure/PickerOptions;->cyclic3:Z

    invoke-virtual {v5, v6, v7, v8}, Lcom/bigkoo/pickerview/view/WheelOptions;->setCyclic(ZZZ)V
    ...
    iget-object v6, v6, Lcom/bigkoo/pickerview/configure/PickerOptions;->font:Landroid/graphics/Typeface;

    invoke-virtual {v5, v6}, Lcom/bigkoo/pickerview/view/WheelOptions;->setTypeface(Landroid/graphics/Typeface;)V

    .line 90
    iget-object v5, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->mPickerOptions:Lcom/bigkoo/pickerview/configure/PickerOptions;

    iget-boolean v5, v5, Lcom/bigkoo/pickerview/configure/PickerOptions;->cancelable:Z

    invoke-virtual {p0, v5}, Lcom/bigkoo/pickerview/view/OptionsPickerView;->setOutSideCancelable(Z)Lcom/bigkoo/pickerview/view/BasePickerView;
    ...
    iget v6, v6, Lcom/bigkoo/pickerview/configure/PickerOptions;->dividerColor:I

    invoke-virtual {v5, v6}, Lcom/bigkoo/pickerview/view/WheelOptions;->setDividerColor(I)V
    ...
    iget-object v6, v6, Lcom/bigkoo/pickerview/configure/PickerOptions;->dividerType:Lcom/contrarywind/view/WheelView$DividerType;

    invoke-virtual {v5, v6}, Lcom/bigkoo/pickerview/view/WheelOptions;->setDividerType(Lcom/contrarywind/view/WheelView$DividerType;)V
    ...
    iget v6, v6, Lcom/bigkoo/pickerview/configure/PickerOptions;->lineSpacingMultiplier:F

    invoke-virtual {v5, v6}, Lcom/bigkoo/pickerview/view/WheelOptions;->setLineSpacingMultiplier(F)V
    ...
    iget v6, v6, Lcom/bigkoo/pickerview/configure/PickerOptions;->textColorOut:I

    invoke-virtual {v5, v6}, Lcom/bigkoo/pickerview/view/WheelOptions;->setTextColorOut(I)V
    ...
    iget v6, v6, Lcom/bigkoo/pickerview/configure/PickerOptions;->textColorCenter:I

    invoke-virtual {v5, v6}, Lcom/bigkoo/pickerview/view/WheelOptions;->setTextColorCenter(I)V
    ...
    iget-boolean v6, v6, Lcom/bigkoo/pickerview/configure/PickerOptions;->isCenterLabel:Z

    invoke-virtual {v5, v6}, Lcom/bigkoo/pickerview/view/WheelOptions;->isCenterLabel(Z)V

    .line 98
    return-void

    .line 57
    .end local v2    # "optionsPicker":Landroid/widget/LinearLayout;
    .restart local v0    # "btnCancel":Landroid/widget/Button;
    .restart local v1    # "btnSubmit":Landroid/widget/Button;
    .restart local v3    # "rv_top_bar":Landroid/widget/RelativeLayout;
    ...
    iget-object v8, p0, Lcom/bigkoo/pickerview/view/OptionsPickerView;->contentContainer:Landroid/view/ViewGroup;
...
.method public returnData()V
    ...
    invoke-virtual {v1}, Lcom/bigkoo/pickerview/view/WheelOptions;->getCurrentItems()[I
