...
.method private readSource()V
    ...
    invoke-interface {v5, v2, v3}, Lcom/danikula/videocache/Source;->open(J)V
    ...
    .line 128
    iget-object v8, p0, Lcom/danikula/videocache/ProxyCache;->stopLock:Ljava/lang/Object;
    ...
    .line 144
    invoke-direct {p0, v2, v3, v6, v7}, Lcom/danikula/videocache/ProxyCache;->notifyNewCacheDataAvailable(JJ)V
    ...
    invoke-interface {v5, v0, v4}, Lcom/danikula/videocache/Cache;->append([BI)V
