...
.method public dismissLoadingDialog()V
    ...
    .line 187
    :try_start_0
    iget-object v1, p0, Lcom/isaigu/gymapp/BaseActivity;->loadingDialog:Lcom/isaigu/gymapp/widget/LoadingDialog;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/isaigu/gymapp/BaseActivity;->loadingDialog:Lcom/isaigu/gymapp/widget/LoadingDialog;

    invoke-virtual {v1}, Lcom/isaigu/gymapp/widget/LoadingDialog;->isShowing()Z
    ...
    invoke-virtual {v1}, Lcom/isaigu/gymapp/widget/LoadingDialog;->cancel()V

    .line 189
    const/4 v1, 0x0

    iput-object v1, p0, Lcom/isaigu/gymapp/BaseActivity;->loadingDialog:Lcom/isaigu/gymapp/widget/LoadingDialog;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public dismissStatusDialog()V
    ...
    .line 198
    :try_start_0
    iget-object v1, p0, Lcom/isaigu/gymapp/BaseActivity;->statusLoadingDialog:Lcom/isaigu/gymapp/widget/StatusLoadingDialog;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/isaigu/gymapp/BaseActivity;->statusLoadingDialog:Lcom/isaigu/gymapp/widget/StatusLoadingDialog;

    invoke-virtual {v1}, Lcom/isaigu/gymapp/widget/StatusLoadingDialog;->isShowing()Z
    ...
    invoke-virtual {v1}, Lcom/isaigu/gymapp/widget/StatusLoadingDialog;->cancel()V

    .line 200
    const/4 v1, 0x0

    iput-object v1, p0, Lcom/isaigu/gymapp/BaseActivity;->statusLoadingDialog:Lcom/isaigu/gymapp/widget/StatusLoadingDialog;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isFragmentShow(Ljava/lang/Class;)Z
    ...
    .line 254
    .local v1, "fragmentList":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/app/Fragment;>;"
    if-eqz v1, :cond_2
...
.method public showDialogFragment(Lcom/isaigu/gymapp/BaseDialogFragment;)V
    ...
    .end local v2    # "fragments":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/app/Fragment;>;"
    :cond_1
    :goto_0
    return-void

    .line 341
    .restart local v2    # "fragments":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/app/Fragment;>;"
    :cond_2
    invoke-super {p0}, Landroid/support/v7/app/AppCompatActivity;->getResources()Landroid/content/res/Resources;

    move-result-object v3

    invoke-static {v3}, Lme/jessyan/autosize/AutoSizeCompat;->autoConvertDensityOfGlobal(Landroid/content/res/Resources;)V
    ...
    invoke-virtual {p1, v3, v4}, Lcom/isaigu/gymapp/BaseDialogFragment;->show(Landroid/support/v4/app/FragmentManager;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public showDialogWithImage(ILjava/lang/String;)V
    ...
    .line 88
    new-instance v1, Lcom/isaigu/gymapp/widget/StatusLoadingDialog$Builder;

    invoke-direct {v1, p0}, Lcom/isaigu/gymapp/widget/StatusLoadingDialog$Builder;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1}, Lcom/isaigu/gymapp/widget/StatusLoadingDialog$Builder;->build()Lcom/isaigu/gymapp/widget/StatusLoadingDialog;
    ...
    invoke-virtual {v1, p1, p2}, Lcom/isaigu/gymapp/widget/StatusLoadingDialog;->setShowWithStatusImage(ILjava/lang/String;)V

    .line 92
    :try_start_0
    iget-object v1, p0, Lcom/isaigu/gymapp/BaseActivity;->statusLoadingDialog:Lcom/isaigu/gymapp/widget/StatusLoadingDialog;

    invoke-virtual {v1}, Lcom/isaigu/gymapp/widget/StatusLoadingDialog;->show()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public showLoadingDialog()V
    ...
    .line 164
    new-instance v1, Lcom/isaigu/gymapp/widget/LoadingDialog$Builder;

    invoke-direct {v1, p0}, Lcom/isaigu/gymapp/widget/LoadingDialog$Builder;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1, v2}, Lcom/isaigu/gymapp/widget/LoadingDialog$Builder;->setCancelable(Z)Lcom/isaigu/gymapp/widget/LoadingDialog$Builder;

    move-result-object v1

    invoke-virtual {v1, v2}, Lcom/isaigu/gymapp/widget/LoadingDialog$Builder;->setCancelOutside(Z)Lcom/isaigu/gymapp/widget/LoadingDialog$Builder;

    move-result-object v1

    invoke-virtual {v1, v2}, Lcom/isaigu/gymapp/widget/LoadingDialog$Builder;->setShowMessage(Z)Lcom/isaigu/gymapp/widget/LoadingDialog$Builder;

    move-result-object v1

    invoke-virtual {v1}, Lcom/isaigu/gymapp/widget/LoadingDialog$Builder;->create()Lcom/isaigu/gymapp/widget/LoadingDialog;
    ...
    invoke-virtual {v1}, Lcom/isaigu/gymapp/widget/LoadingDialog;->show()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public showLoadingDialogWithText(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p1}, Lcom/isaigu/gymapp/widget/StatusLoadingDialog;->setShowWithProgressText(Ljava/lang/String;)V
...
.method public showLoadingDialogWithText(Ljava/lang/String;I)V
    ...
    invoke-virtual {v1, p1, p2}, Lcom/isaigu/gymapp/widget/StatusLoadingDialog;->setShowWithProgressText(Ljava/lang/String;I)V
...
.method public showMessageDialog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    .line 215
    .local v3, "logTextView":Landroid/widget/TextView;
    ...
    .line 217
    .local v4, "sureButton":Landroid/widget/Button;
    const v5, 0x7f0f0136
    ...
    iput-object v5, p0, Lcom/isaigu/gymapp/BaseActivity;->messageDialog:Landroid/support/v7/app/AlertDialog;

    .line 221
    iget-object v5, p0, Lcom/isaigu/gymapp/BaseActivity;->messageDialog:Landroid/support/v7/app/AlertDialog;

    invoke-virtual {v5}, Landroid/support/v7/app/AlertDialog;->getWindow()Landroid/view/Window;
    ...
    .line 223
    new-instance v5, Lcom/isaigu/gymapp/BaseActivity$5;

    invoke-direct {v5, p0, p4}, Lcom/isaigu/gymapp/BaseActivity$5;-><init>(Lcom/isaigu/gymapp/BaseActivity;Ljava/lang/Runnable;)V

    invoke-virtual {v4, v5}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 231
    new-instance v5, Lcom/isaigu/gymapp/BaseActivity$6;

    invoke-direct {v5, p0}, Lcom/isaigu/gymapp/BaseActivity$6;-><init>(Lcom/isaigu/gymapp/BaseActivity;)V
    ...
    .end local v3    # "logTextView":Landroid/widget/TextView;
    .end local v4    # "sureButton":Landroid/widget/Button;
    :goto_0
    return-void
