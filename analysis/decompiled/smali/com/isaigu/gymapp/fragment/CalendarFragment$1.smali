...
.method public onAddClick(III)V
    ...
    .line 109
    invoke-static {v2}, Lcom/isaigu/gymapp/fragment/CalendarFragment;->access$200(Lcom/isaigu/gymapp/fragment/CalendarFragment;)Ljava/util/List;

    move-result-object v2

    iget-object v3, p0, Lcom/isaigu/gymapp/fragment/CalendarFragment$1;->this$0:Lcom/isaigu/gymapp/fragment/CalendarFragment;

    invoke-static {v3}, Lcom/isaigu/gymapp/fragment/CalendarFragment;->access$300(Lcom/isaigu/gymapp/fragment/CalendarFragment;)Ljava/util/List;

    move-result-object v3

    iget-object v4, p0, Lcom/isaigu/gymapp/fragment/CalendarFragment$1;->this$0:Lcom/isaigu/gymapp/fragment/CalendarFragment;

    .line 110
    invoke-static {v4}, Lcom/isaigu/gymapp/fragment/CalendarFragment;->access$400(Lcom/isaigu/gymapp/fragment/CalendarFragment;)Ljava/util/List;

    move-result-object v4

    new-instance v5, Lcom/isaigu/gymapp/fragment/CalendarFragment$1$2;

    invoke-direct {v5, p0, p1, p2, p3}, Lcom/isaigu/gymapp/fragment/CalendarFragment$1$2;-><init>(Lcom/isaigu/gymapp/fragment/CalendarFragment$1;III)V

    .line 108
    invoke-static/range {v0 .. v5}, Lcom/isaigu/gymapp/UIFactory;->showOptionView3(Landroid/content/Context;Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Lcom/isaigu/gymapp/UIFactory$OptionSelectListener3;)V
...
.method public onDayClick(IIILcom/isaigu/gymapp/bean/ProgramPlanBean;)V
    ...
    .line 88
    new-instance v1, Lcom/isaigu/gymapp/dialog/ProgramPlanDialog;

    invoke-direct {v1}, Lcom/isaigu/gymapp/dialog/ProgramPlanDialog;-><init>()V

    .line 89
    .local v1, "dialog":Lcom/isaigu/gymapp/dialog/ProgramPlanDialog;
    ...
    .line 91
    invoke-virtual {v1, v0}, Lcom/isaigu/gymapp/dialog/ProgramPlanDialog;->setArguments(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1, v2}, Lcom/isaigu/gymapp/dialog/ProgramPlanDialog;->setListener(Lcom/isaigu/gymapp/dialog/ProgramPlanDialog$ProgramPlanRemoveListener;)V
    ...
    .end local v1    # "dialog":Lcom/isaigu/gymapp/dialog/ProgramPlanDialog;
    :cond_0
    return-void
.end method
...
.method public onLeftRowClick()V
    ...
    invoke-virtual {v1, v2}, Lcom/isaigu/gymapp/widget/CustomCalendar;->monthChange(I)V
    ...
    invoke-virtual {v1}, Lcom/isaigu/gymapp/widget/CustomCalendar;->getMonth()Ljava/util/Date;
