...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/isaigu/gymapp/utils/AndroidUtils;->defaultWidth:F

    .line 56
    const/high16 v0, 0x44340000    # 720.0f

    sput v0, Lcom/isaigu/gymapp/utils/AndroidUtils;->defaultHeight:F

    .line 57
    sget v0, Lcom/isaigu/gymapp/utils/AndroidUtils;->defaultWidth:F

    sget v1, Lcom/isaigu/gymapp/utils/AndroidUtils;->DEFAULT_DENSITY:I

    int-to-float v1, v1

    div-float/2addr v0, v1

    sput v0, Lcom/isaigu/gymapp/utils/AndroidUtils;->w2:F

    .line 59
    sget v0, Lcom/isaigu/gymapp/utils/AndroidUtils;->defaultHeight:F
    ...
    sget v1, Lcom/isaigu/gymapp/utils/AndroidUtils;->defaultWidth:F
    ...
    sget v1, Lcom/isaigu/gymapp/utils/AndroidUtils;->defaultHeight:F
...
.method public static compressImageFile(Ljava/io/File;F)Ljava/io/File;
    ...
    .line 431
    .local v4, "imgNameCrop":Ljava/lang/String;
    ...
    const-string v8, "com.isaigu.gymapp"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    const-string v8, "/CropPicture"
    ...
    .line 432
    .local v6, "pictureDirCrop":Ljava/io/File;
    ...
    invoke-static {v4, v7, v6}, Ljava/io/File;->createTempFile(Ljava/lang/String;Ljava/lang/String;Ljava/io/File;)Ljava/io/File;
    ...
    .end local v4    # "imgNameCrop":Ljava/lang/String;
    .end local v5    # "o":Landroid/graphics/BitmapFactory$Options;
    .end local v6    # "pictureDirCrop":Ljava/io/File;
    :goto_0
    return-object v3
...
.method public static declared-synchronized getAndroidUUID()Ljava/lang/String;
    ...
    .prologue
    .line 251
    const-class v6, Lcom/isaigu/gymapp/utils/AndroidUtils;

    monitor-enter v6

    :try_start_0
    sget-object v5, Lcom/isaigu/gymapp/utils/AndroidUtils;->context:Landroid/content/Context;
    ...
    invoke-static {v5}, Lcom/isaigu/gymapp/utils/Logger;->logConsole(Ljava/lang/String;)V
    :try_end_1
...
.method public static isVirtualButtonHide(Landroid/content/Context;)Z
    ...
    const-string v9, "SHOW_NAVIGATION_BAR"

    invoke-static {v8, v9}, Lcom/isaigu/gymapp/utils/ReflectionUtils;->getClassFieldValue(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v8, v9}, Lcom/isaigu/gymapp/utils/Logger;->logConsole(Ljava/lang/String;Ljava/lang/String;)V

    .line 103
    :try_start_1
    const-class v8, Landroid/provider/Settings$System;

    const-string v9, "HIDER_BUTTON_SHOW"
    ...
    const-string v9, "full_screen_mode"
    ...
    invoke-static {v6, v8}, Lcom/isaigu/gymapp/utils/Logger;->logConsole(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static onRequestPermissionsResult(Landroid/app/Activity;I[Ljava/lang/String;[I)V
    ...
    .line 524
    sget-object v3, Lcom/isaigu/gymapp/utils/AndroidUtils;->callbackHashMap:Ljava/util/HashMap;
    ...
    :goto_0
    invoke-interface {v0, v5, p1, v3}, Lcom/isaigu/gymapp/utils/AndroidUtils$RequestPermissionCallback;->onRequestPermission(Ljava/lang/String;IZ)V
...
.method public static requestPermission(Landroid/app/Activity;Ljava/lang/String;ILcom/isaigu/gymapp/utils/AndroidUtils$RequestPermissionCallback;)V
    ...
    .line 511
    invoke-interface {p3, p1, p2, v2}, Lcom/isaigu/gymapp/utils/AndroidUtils$RequestPermissionCallback;->onRequestPermission(Ljava/lang/String;IZ)V
...
.method public static selectImageFromGallery(Landroid/support/v4/app/Fragment;ILjava/io/File;)Landroid/net/Uri;
    ...
    invoke-static {v3, v4, p2}, Landroid/support/v4/content/FileProvider;->getUriForFile(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;)Landroid/net/Uri;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static setKeyBoardVisible(Landroid/app/Activity;Landroid/view/View;Z)V
    ...
    .line 171
    .restart local v0    # "manager":Landroid/view/inputmethod/InputMethodManager;
    :cond_1
...
.method public static setSpText(I)F
    ...
    .prologue
    .line 501
    sget v2, Lcom/isaigu/gymapp/utils/AndroidUtils;->_scaleWidth:F

    sget v3, Lcom/isaigu/gymapp/utils/AndroidUtils;->_scaleHeight:F
    ...
    .line 502
    .local v1, "scale":F
    sget v0, Lcom/isaigu/gymapp/utils/AndroidUtils;->fontScale:F
    ...
    sget v3, Lcom/isaigu/gymapp/utils/AndroidUtils;->fontScale:F
    ...
    sget v3, Lcom/isaigu/gymapp/utils/AndroidUtils;->screenW:I
...
.method public static setVirtualButtonVisible(Landroid/content/Context;Z)V
    ...
    const-string v6, "SHOW_NAVIGATION_BAR"

    invoke-static {v5, v6}, Lcom/isaigu/gymapp/utils/ReflectionUtils;->getClassFieldValue(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
    ...
    const-string v6, "HIDER_BUTTON_SHOW"
    ...
    .line 132
    .local v1, "fValue":Ljava/lang/String;
    if-eqz p1, :cond_0
    ...
    .line 143
    .end local v1    # "fValue":Ljava/lang/String;
    :goto_1
    :try_start_2
    invoke-virtual {p0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;
    ...
    const-string v6, "full_screen_mode"
    ...
    invoke-static {v5, v6}, Lcom/isaigu/gymapp/utils/Logger;->logConsole(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    .line 135
    .end local v0    # "e":Ljava/lang/Exception;
    .restart local v1    # "fValue":Ljava/lang/String;
    :cond_0
    :try_start_3
    invoke-virtual {p0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;
    ...
    invoke-static {v3, v4}, Lcom/isaigu/gymapp/utils/Logger;->logConsole(Ljava/lang/String;Ljava/lang/String;)V
