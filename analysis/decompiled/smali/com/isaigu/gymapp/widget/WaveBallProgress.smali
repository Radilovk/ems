...
.method private getWaveY(IIIF)D
    ...
    iget v4, p0, Lcom/isaigu/gymapp/widget/WaveBallProgress;->mProgress:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget v0, p0, Lcom/isaigu/gymapp/widget/WaveBallProgress;->mWaveColor:I
    ...
    invoke-direct {v7, v0, v1, v3, v4}, Landroid/graphics/RectF;-><init>(FFFF)V

    .line 218
    .local v7, "edge":Landroid/graphics/RectF;
    const/4 v0, 0x0
    ...
    .line 220
    .local v10, "sc":I
    iget-boolean v0, p0, Lcom/isaigu/gymapp/widget/WaveBallProgress;->isWaveMoving:Z
    ...
    iget v3, p0, Lcom/isaigu/gymapp/widget/WaveBallProgress;->mWaveHeightA:I

    iget v4, p0, Lcom/isaigu/gymapp/widget/WaveBallProgress;->mWaveACycle:F

    invoke-direct {p0, v8, v0, v3, v4}, Lcom/isaigu/gymapp/widget/WaveBallProgress;->getWaveY(IIIF)D
    ...
    iget v1, p0, Lcom/isaigu/gymapp/widget/WaveBallProgress;->mProgress:I
    ...
    .line 239
    iget-object v0, p0, Lcom/isaigu/gymapp/widget/WaveBallProgress;->mBallBitmap:Landroid/graphics/Bitmap;

    const/4 v1, 0x0

    const/4 v3, 0x0

    iget-object v4, p0, Lcom/isaigu/gymapp/widget/WaveBallProgress;->mWavePaint:Landroid/graphics/Paint;
    ...
    .line 244
    .end local v7    # "edge":Landroid/graphics/RectF;
...
.method protected onSizeChanged(IIII)V
    ...
    iput v2, p0, Lcom/isaigu/gymapp/widget/WaveBallProgress;->mWaveSpeedA:I
    ...
    invoke-static {v2, v6}, Lcom/isaigu/gymapp/utils/AndroidUtils;->dip2px(Landroid/content/Context;F)I

    move-result v2

    iput v2, p0, Lcom/isaigu/gymapp/widget/WaveBallProgress;->mWaveHeightA:I
    ...
    iput v2, p0, Lcom/isaigu/gymapp/widget/WaveBallProgress;->mWaveACycle:F
    ...
    iput-object v2, p0, Lcom/isaigu/gymapp/widget/WaveBallProgress;->mBallBitmap:Landroid/graphics/Bitmap;
    ...
    .line 197
    .local v0, "ball":Landroid/graphics/RectF;
    ...
    .line 199
    .end local v0    # "ball":Landroid/graphics/RectF;
...
.method public startProgress(IJJ)V
    ...
    .line 132
    invoke-virtual {p0, v2}, Lcom/isaigu/gymapp/widget/WaveBallProgress;->setProgress(I)V
