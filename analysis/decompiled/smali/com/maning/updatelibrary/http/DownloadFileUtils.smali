...
.method public static cancleAll()V
    ...
    .line 398
    :try_start_0
    sget-object v4, Lcom/maning/updatelibrary/http/DownloadFileUtils;->mCallHashMap:Ljava/util/HashMap;
    ...
    .line 401
    .local v3, "keyEntries":Ljava/util/Set;, "Ljava/util/Set<Ljava/util/Map$Entry<Ljava/lang/Object;Lokhttp3/Call;>;>;"
    ...
    .line 403
    .local v1, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/Object;Lokhttp3/Call;>;"
    ...
    .line 416
    .end local v0    # "call":Lokhttp3/Call;
    .end local v1    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/Object;Lokhttp3/Call;>;"
...
.method public static getOkhttpDefaultBuilder()Lokhttp3/OkHttpClient$Builder;
    ...
    .line 326
    new-instance v5, Lcom/maning/updatelibrary/http/DownloadFileUtils$5;

    invoke-direct {v5}, Lcom/maning/updatelibrary/http/DownloadFileUtils$5;-><init>()V
    ...
    new-instance v0, Lcom/maning/updatelibrary/http/DownloadFileUtils$6;

    invoke-direct {v0}, Lcom/maning/updatelibrary/http/DownloadFileUtils$6;-><init>()V

    .line 358
    .local v0, "DO_NOT_VERIFY":Ljavax/net/ssl/HostnameVerifier;
    ...
    invoke-virtual {v1, v10, v11, v6}, Lokhttp3/OkHttpClient$Builder;->connectTimeout(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;

    .line 360
    sget-object v6, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v1, v10, v11, v6}, Lokhttp3/OkHttpClient$Builder;->readTimeout(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;

    .line 361
    sget-object v6, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v1, v10, v11, v6}, Lokhttp3/OkHttpClient$Builder;->writeTimeout(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;
    ...
    .line 345
    .end local v0    # "DO_NOT_VERIFY":Ljavax/net/ssl/HostnameVerifier;
...
.method private startDonwload()V
    ...
    .prologue
    .line 174
    iget-object v9, p0, Lcom/maning/updatelibrary/http/DownloadFileUtils;->downloadModel:Lcom/maning/updatelibrary/http/DownloadModel;
    ...
    const-string v10, "OkhttpRequestModel\u521d\u59cb\u5316\u5931\u8d25"
    ...
    invoke-virtual {v9}, Lcom/maning/updatelibrary/http/DownloadModel;->getHttpUrl()Ljava/lang/String;
    ...
    invoke-virtual {v9}, Lcom/maning/updatelibrary/http/DownloadModel;->getTag()Ljava/lang/Object;
    ...
    invoke-virtual {v9}, Lcom/maning/updatelibrary/http/DownloadModel;->getHeadersMap()Ljava/util/Map;
    ...
    invoke-virtual {v9}, Lcom/maning/updatelibrary/http/DownloadModel;->getDownloadPath()Ljava/lang/String;
    ...
    invoke-virtual {v9}, Lcom/maning/updatelibrary/http/DownloadModel;->getFileProgressCallback()Lcom/maning/updatelibrary/http/AbsFileProgressCallback;

    move-result-object v2

    .line 193
    .local v2, "fileProgressCallback":Lcom/maning/updatelibrary/http/AbsFileProgressCallback;
    invoke-static {}, Lcom/maning/updatelibrary/http/DownloadFileUtils;->getOkhttpDefaultBuilder()Lokhttp3/OkHttpClient$Builder;

    move-result-object v6

    .line 195
    .local v6, "okhttpBuilder":Lokhttp3/OkHttpClient$Builder;
    new-instance v7, Lokhttp3/Request$Builder;

    invoke-direct {v7}, Lokhttp3/Request$Builder;-><init>()V

    .line 197
    .local v7, "requestBuild":Lokhttp3/Request$Builder;
    ...
    invoke-virtual {v7, v5, v9}, Lokhttp3/Request$Builder;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/Request$Builder;
    ...
    :cond_2
    new-instance v9, Lcom/maning/updatelibrary/http/DownloadFileUtils$2;

    invoke-direct {v9, p0, v2}, Lcom/maning/updatelibrary/http/DownloadFileUtils$2;-><init>(Lcom/maning/updatelibrary/http/DownloadFileUtils;Lcom/maning/updatelibrary/http/AbsFileProgressCallback;)V

    invoke-virtual {v6, v9}, Lokhttp3/OkHttpClient$Builder;->addNetworkInterceptor(Lokhttp3/Interceptor;)Lokhttp3/OkHttpClient$Builder;

    .line 213
    sget-object v9, Lcom/maning/updatelibrary/http/DownloadFileUtils;->mUIHandler:Landroid/os/Handler;

    new-instance v10, Lcom/maning/updatelibrary/http/DownloadFileUtils$3;

    invoke-direct {v10, p0, v2}, Lcom/maning/updatelibrary/http/DownloadFileUtils$3;-><init>(Lcom/maning/updatelibrary/http/DownloadFileUtils;Lcom/maning/updatelibrary/http/AbsFileProgressCallback;)V
    ...
    invoke-virtual {v9, v10}, Lokhttp3/OkHttpClient;->newCall(Lokhttp3/Request;)Lokhttp3/Call;

    move-result-object v0

    .line 221
    .local v0, "call":Lokhttp3/Call;
    sget-object v9, Lcom/maning/updatelibrary/http/DownloadFileUtils;->mCallHashMap:Ljava/util/HashMap;

    invoke-virtual {v9, v8, v0}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 222
    new-instance v9, Lcom/maning/updatelibrary/http/DownloadFileUtils$4;

    invoke-direct {v9, p0, v2, v1}, Lcom/maning/updatelibrary/http/DownloadFileUtils$4;-><init>(Lcom/maning/updatelibrary/http/DownloadFileUtils;Lcom/maning/updatelibrary/http/AbsFileProgressCallback;Ljava/lang/String;)V

    invoke-interface {v0, v9}, Lokhttp3/Call;->enqueue(Lokhttp3/Callback;)V
