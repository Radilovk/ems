...
.method private createTitle(Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuItem;)Landroid/widget/TextView;
    ...
    .line 121
    invoke-static {v3, v0}, Landroid/support/v4/widget/TextViewCompat;->setTextAppearance(Landroid/widget/TextView;I)V
...
.method public createMenu(Lcom/yanzhenjie/recyclerview/swipe/SwipeMenu;Lcom/yanzhenjie/recyclerview/swipe/SwipeSwitch;Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuItemClickListener;I)V
    ...
    .line 68
    .local v2, "items":Ljava/util/List;, "Ljava/util/List<Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuItem;>;"
    const/4 v0, 0x0
    ...
    check-cast v1, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuItem;

    .line 71
    .local v1, "item":Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuItem;
    new-instance v5, Landroid/widget/LinearLayout$LayoutParams;

    invoke-virtual {v1}, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuItem;->getWidth()I

    move-result v8

    invoke-virtual {v1}, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuItem;->getHeight()I
    ...
    invoke-virtual {v1}, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuItem;->getWeight()I
    ...
    .line 78
    invoke-virtual {v1}, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuItem;->getBackground()Landroid/graphics/drawable/Drawable;

    move-result-object v8

    invoke-static {v6, v8}, Landroid/support/v4/view/ViewCompat;->setBackground(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    .line 79
    invoke-virtual {v6, p0}, Landroid/widget/LinearLayout;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 80
    invoke-virtual {p0, v6}, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuView;->addView(Landroid/view/View;)V

    .line 82
    new-instance v4, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuBridge;

    iget v8, p0, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuView;->mDirection:I

    iget-object v9, p0, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuView;->mSwipeSwitch:Lcom/yanzhenjie/recyclerview/swipe/SwipeSwitch;

    invoke-direct {v4, v8, v0, v9, v6}, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuBridge;-><init>(IILcom/yanzhenjie/recyclerview/swipe/SwipeSwitch;Landroid/view/View;)V

    .line 83
    .local v4, "menuBridge":Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuBridge;
    invoke-virtual {v6, v4}, Landroid/widget/LinearLayout;->setTag(Ljava/lang/Object;)V

    .line 85
    invoke-virtual {v1}, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuItem;->getImage()Landroid/graphics/drawable/Drawable;
    ...
    .line 86
    invoke-direct {p0, v1}, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuView;->createIcon(Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuItem;)Landroid/widget/ImageView;

    move-result-object v3

    .line 87
    .local v3, "iv":Landroid/widget/ImageView;
    iput-object v3, v4, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuBridge;->mImageView:Landroid/widget/ImageView;
    ...
    :cond_0
    invoke-virtual {v1}, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuItem;->getText()Ljava/lang/String;
    ...
    .line 92
    invoke-direct {p0, v1}, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuView;->createTitle(Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuItem;)Landroid/widget/TextView;

    move-result-object v7

    .line 93
    .local v7, "tv":Landroid/widget/TextView;
    iput-object v7, v4, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuBridge;->mTextView:Landroid/widget/TextView;
    ...
    .line 97
    .end local v1    # "item":Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuItem;
    .end local v4    # "menuBridge":Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuBridge;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v1, p0, Lcom/yanzhenjie/recyclerview/swipe/SwipeMenuView;->mSwipeSwitch:Lcom/yanzhenjie/recyclerview/swipe/SwipeSwitch;

    invoke-interface {v1}, Lcom/yanzhenjie/recyclerview/swipe/SwipeSwitch;->isMenuOpen()Z
