...
.method private constructor <init>()V
    ...
    .line 103
    iput-boolean v1, p0, Lme/jessyan/autosize/AutoSizeConfig;->isBaseOnWidth:Z

    .line 109
    iput-boolean v1, p0, Lme/jessyan/autosize/AutoSizeConfig;->isUseDeviceSize:Z
...
.method public static getInstance()Lme/jessyan/autosize/AutoSizeConfig;
    ...
    .line 150
    const-class v1, Lme/jessyan/autosize/AutoSizeConfig;
    ...
    .line 152
    new-instance v0, Lme/jessyan/autosize/AutoSizeConfig;

    invoke-direct {v0}, Lme/jessyan/autosize/AutoSizeConfig;-><init>()V

    sput-object v0, Lme/jessyan/autosize/AutoSizeConfig;->sInstance:Lme/jessyan/autosize/AutoSizeConfig;
...
.method public getDesignHeightInDp()I
    ...
    :goto_0
    const-string/jumbo v1, "you must set design_height_in_dp  in your AndroidManifest file"
...
.method public getDesignWidthInDp()I
    ...
    :goto_0
    const-string/jumbo v1, "you must set design_width_in_dp  in your AndroidManifest file"
...
.method init(Landroid/app/Application;ZLme/jessyan/autosize/AutoAdaptStrategy;)Lme/jessyan/autosize/AutoSizeConfig;
    ...
    .line 197
    iget v3, p0, Lme/jessyan/autosize/AutoSizeConfig;->mInitDensity:F
    ...
    :goto_0
    const-string v6, "AutoSizeConfig#init() can only be called once"

    invoke-static {v3, v6}, Lme/jessyan/autosize/utils/Preconditions;->checkArgument(ZLjava/lang/Object;)V

    .line 198
    const-string v3, "application == null"

    invoke-static {p1, v3}, Lme/jessyan/autosize/utils/Preconditions;->checkNotNull(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput v3, p0, Lme/jessyan/autosize/AutoSizeConfig;->mScreenWidth:I

    .line 207
    aget v3, v2, v4

    iput v3, p0, Lme/jessyan/autosize/AutoSizeConfig;->mScreenHeight:I
    ...
    iput v3, p0, Lme/jessyan/autosize/AutoSizeConfig;->mStatusBarHeight:I
    ...
    const-string v5, "designWidthInDp = "

    invoke-virtual {v3, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v5, p0, Lme/jessyan/autosize/AutoSizeConfig;->mDesignWidthInDp:I

    invoke-virtual {v3, v5}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v5, ", designHeightInDp = "

    invoke-virtual {v3, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v5, p0, Lme/jessyan/autosize/AutoSizeConfig;->mDesignHeightInDp:I
    ...
    iget v5, p0, Lme/jessyan/autosize/AutoSizeConfig;->mScreenWidth:I
    ...
    iget v5, p0, Lme/jessyan/autosize/AutoSizeConfig;->mScreenHeight:I
    ...
    invoke-static {v3}, Lme/jessyan/autosize/utils/LogUtils;->d(Ljava/lang/String;)V

    .line 211
    iget v3, v0, Landroid/util/DisplayMetrics;->density:F

    iput v3, p0, Lme/jessyan/autosize/AutoSizeConfig;->mInitDensity:F

    .line 212
    iget v3, v0, Landroid/util/DisplayMetrics;->densityDpi:I

    iput v3, p0, Lme/jessyan/autosize/AutoSizeConfig;->mInitDensityDpi:I

    .line 213
    iget v3, v0, Landroid/util/DisplayMetrics;->scaledDensity:F

    iput v3, p0, Lme/jessyan/autosize/AutoSizeConfig;->mInitScaledDensity:F

    .line 214
    iget v3, v0, Landroid/util/DisplayMetrics;->xdpi:F

    iput v3, p0, Lme/jessyan/autosize/AutoSizeConfig;->mInitXdpi:F

    .line 215
    new-instance v3, Lme/jessyan/autosize/AutoSizeConfig$1;

    invoke-direct {v3, p0, p1}, Lme/jessyan/autosize/AutoSizeConfig$1;-><init>(Lme/jessyan/autosize/AutoSizeConfig;Landroid/app/Application;)V
    ...
    const-string v5, "initDensity = "

    invoke-virtual {v3, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v5, p0, Lme/jessyan/autosize/AutoSizeConfig;->mInitDensity:F

    invoke-virtual {v3, v5}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v5, ", initScaledDensity = "

    invoke-virtual {v3, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v5, p0, Lme/jessyan/autosize/AutoSizeConfig;->mInitScaledDensity:F
    ...
    .line 237
    new-instance v3, Lme/jessyan/autosize/ActivityLifecycleCallbacksImpl;

    if-nez p3, :cond_0

    new-instance p3, Lme/jessyan/autosize/WrapperAutoAdaptStrategy;

    .end local p3    # "strategy":Lme/jessyan/autosize/AutoAdaptStrategy;
    ...
    invoke-direct {p3, v5}, Lme/jessyan/autosize/WrapperAutoAdaptStrategy;-><init>(Lme/jessyan/autosize/AutoAdaptStrategy;)V

    :cond_0
    invoke-direct {v3, p3}, Lme/jessyan/autosize/ActivityLifecycleCallbacksImpl;-><init>(Lme/jessyan/autosize/AutoAdaptStrategy;)V

    iput-object v3, p0, Lme/jessyan/autosize/AutoSizeConfig;->mActivityLifecycleCallbacks:Lme/jessyan/autosize/ActivityLifecycleCallbacksImpl;

    .line 238
    iget-object v3, p0, Lme/jessyan/autosize/AutoSizeConfig;->mActivityLifecycleCallbacks:Lme/jessyan/autosize/ActivityLifecycleCallbacksImpl;
    ...
    .line 240
    :cond_1
    iput-boolean v4, p0, Lme/jessyan/autosize/AutoSizeConfig;->isMiui:Z
    ...
    iput-object v3, p0, Lme/jessyan/autosize/AutoSizeConfig;->mTmpMetricsField:Ljava/lang/reflect/Field;

    .line 243
    iget-object v3, p0, Lme/jessyan/autosize/AutoSizeConfig;->mTmpMetricsField:Ljava/lang/reflect/Field;
    ...
    .restart local p3    # "strategy":Lme/jessyan/autosize/AutoAdaptStrategy;
    :cond_3
    move v3, v5
...
.method public restart()V
    ...
    iput-boolean v0, p0, Lme/jessyan/autosize/AutoSizeConfig;->isStop:Z
