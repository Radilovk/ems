...
.method public constructor <init>()V
    ...
    .line 281
    iput v1, p0, Lorg/apache/commons/mail/Email;->socketTimeout:I

    .line 284
    iput v1, p0, Lorg/apache/commons/mail/Email;->socketConnectionTimeout:I
...
.method private createFoldedHeaderValue(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lorg/apache/commons/mail/EmailUtils;->isEmpty(Ljava/lang/String;)Z
    ...
    const-string/jumbo v3, "value can not be null or empty"
    ...
    iget-object v4, p0, Lorg/apache/commons/mail/Email;->charset:Ljava/lang/String;

    const/4 v5, 0x0

    invoke-static {v3, v4, v5}, Ljavax/mail/internet/MimeUtility;->encodeText(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private createInternetAddress(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljavax/mail/internet/InternetAddress;
    ...
    :try_end_0
    .catch Ljavax/mail/internet/AddressException; {:try_start_0 .. :try_end_0} :catch_3
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_0 .. :try_end_0} :catch_1

    .line 1898
    .end local v0    # "address":Ljavax/mail/internet/InternetAddress;
    ...
    .line 1903
    invoke-virtual {v1, p2}, Ljavax/mail/internet/InternetAddress;->setPersonal(Ljava/lang/String;)V
    ...
    .line 1910
    .local v3, "set":Ljava/nio/charset/Charset;
    invoke-virtual {v3}, Ljava/nio/charset/Charset;->name()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v1, p2, v4}, Ljavax/mail/internet/InternetAddress;->setPersonal(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    .catch Ljavax/mail/internet/AddressException; {:try_start_1 .. :try_end_1} :catch_0
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_1 .. :try_end_1} :catch_2

    goto :goto_0

    .line 1918
    .end local v3    # "set":Ljava/nio/charset/Charset;
    :catch_0
    move-exception v2
    ...
    .restart local v0    # "address":Ljavax/mail/internet/InternetAddress;
    .local v2, "e":Ljavax/mail/internet/AddressException;
    :goto_1
    new-instance v4, Lorg/apache/commons/mail/EmailException;

    invoke-direct {v4, v2}, Lorg/apache/commons/mail/EmailException;-><init>(Ljava/lang/Throwable;)V

    throw v4

    .line 1922
    .end local v2    # "e":Ljavax/mail/internet/AddressException;
    :catch_1
    move-exception v2
    ...
    .restart local v1    # "address":Ljavax/mail/internet/InternetAddress;
    :catch_2
    move-exception v2
...
.method public varargs addBcc([Ljava/lang/String;)Lorg/apache/commons/mail/Email;
    ...
    const-string v5, "Address List provided was invalid"
    ...
    invoke-virtual {p0, v1, v4}, Lorg/apache/commons/mail/Email;->addBcc(Ljava/lang/String;Ljava/lang/String;)Lorg/apache/commons/mail/Email;
...
.method public varargs addCc([Ljava/lang/String;)Lorg/apache/commons/mail/Email;
    ...
    invoke-virtual {p0, v1, v4}, Lorg/apache/commons/mail/Email;->addCc(Ljava/lang/String;Ljava/lang/String;)Lorg/apache/commons/mail/Email;
...
.method public addHeader(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "value can not be null or empty"
...
.method public varargs addTo([Ljava/lang/String;)Lorg/apache/commons/mail/Email;
    ...
    invoke-virtual {p0, v1, v4}, Lorg/apache/commons/mail/Email;->addTo(Ljava/lang/String;Ljava/lang/String;)Lorg/apache/commons/mail/Email;
...
.method public buildMimeMessage()V
    ...
    .prologue
    .line 1269
    iget-object v5, p0, Lorg/apache/commons/mail/Email;->message:Ljavax/mail/internet/MimeMessage;
    ...
    const-string v6, "The MimeMessage is already built."
    ...
    invoke-virtual {p0, v5}, Lorg/apache/commons/mail/Email;->createMimeMessage(Ljavax/mail/Session;)Ljavax/mail/internet/MimeMessage;

    move-result-object v5

    iput-object v5, p0, Lorg/apache/commons/mail/Email;->message:Ljavax/mail/internet/MimeMessage;

    .line 1280
    iget-object v5, p0, Lorg/apache/commons/mail/Email;->subject:Ljava/lang/String;
    ...
    .line 1282
    iget-object v5, p0, Lorg/apache/commons/mail/Email;->charset:Ljava/lang/String;
    ...
    iget-object v6, p0, Lorg/apache/commons/mail/Email;->subject:Ljava/lang/String;

    iget-object v7, p0, Lorg/apache/commons/mail/Email;->charset:Ljava/lang/String;

    invoke-virtual {v5, v6, v7}, Ljavax/mail/internet/MimeMessage;->setSubject(Ljava/lang/String;Ljava/lang/String;)V

    .line 1293
    :cond_1
    :goto_0
    iget-object v5, p0, Lorg/apache/commons/mail/Email;->contentType:Ljava/lang/String;

    invoke-virtual {p0, v5}, Lorg/apache/commons/mail/Email;->updateContentType(Ljava/lang/String;)V

    .line 1295
    iget-object v5, p0, Lorg/apache/commons/mail/Email;->content:Ljava/lang/Object;
    ...
    iget-object v6, p0, Lorg/apache/commons/mail/Email;->contentType:Ljava/lang/String;
    ...
    iget-object v6, p0, Lorg/apache/commons/mail/Email;->content:Ljava/lang/Object;
    ...
    invoke-virtual {v5, v6, v7}, Ljavax/mail/internet/MimeMessage;->setText(Ljava/lang/String;Ljava/lang/String;)V

    .line 1325
    :goto_1
    iget-object v5, p0, Lorg/apache/commons/mail/Email;->fromAddress:Ljavax/mail/internet/InternetAddress;
    ...
    iget-object v6, p0, Lorg/apache/commons/mail/Email;->fromAddress:Ljavax/mail/internet/InternetAddress;

    invoke-virtual {v5, v6}, Ljavax/mail/internet/MimeMessage;->setFrom(Ljavax/mail/Address;)V

    .line 1338
    :cond_2
    iget-object v5, p0, Lorg/apache/commons/mail/Email;->toList:Ljava/util/List;

    invoke-interface {v5}, Ljava/util/List;->size()I

    move-result v5

    iget-object v6, p0, Lorg/apache/commons/mail/Email;->ccList:Ljava/util/List;
    ...
    iget-object v6, p0, Lorg/apache/commons/mail/Email;->bccList:Ljava/util/List;
    ...
    const-string v6, "At least one receiver address required"
    ...
    invoke-virtual {v5, v6}, Ljavax/mail/internet/MimeMessage;->setSubject(Ljava/lang/String;)V
    ...
    iget-object v7, p0, Lorg/apache/commons/mail/Email;->contentType:Ljava/lang/String;

    invoke-virtual {v5, v6, v7}, Ljavax/mail/internet/MimeMessage;->setContent(Ljava/lang/Object;Ljava/lang/String;)V

    goto :goto_1

    .line 1309
    :cond_5
    iget-object v5, p0, Lorg/apache/commons/mail/Email;->emailBody:Ljavax/mail/internet/MimeMultipart;
    ...
    iget-object v6, p0, Lorg/apache/commons/mail/Email;->emailBody:Ljavax/mail/internet/MimeMultipart;

    invoke-virtual {v5, v6}, Ljavax/mail/internet/MimeMessage;->setContent(Ljavax/mail/Multipart;)V
    ...
    invoke-virtual {v5, v6}, Ljavax/mail/internet/MimeMessage;->setText(Ljava/lang/String;)V

    goto :goto_1

    .line 1331
    :cond_8
    iget-object v5, p0, Lorg/apache/commons/mail/Email;->session:Ljavax/mail/Session;

    const-string v6, "mail.smtp.from"
    ...
    const-string v6, "From address required"
    ...
    iget-object v7, p0, Lorg/apache/commons/mail/Email;->toList:Ljava/util/List;

    invoke-virtual {p0, v7}, Lorg/apache/commons/mail/Email;->toInternetAddressArray(Ljava/util/List;)[Ljavax/mail/internet/InternetAddress;

    move-result-object v7

    invoke-virtual {v5, v6, v7}, Ljavax/mail/internet/MimeMessage;->setRecipients(Ljavax/mail/Message$RecipientType;[Ljavax/mail/Address;)V

    .line 1350
    :cond_a
    iget-object v5, p0, Lorg/apache/commons/mail/Email;->ccList:Ljava/util/List;
    ...
    iget-object v7, p0, Lorg/apache/commons/mail/Email;->ccList:Ljava/util/List;
    ...
    .line 1357
    :cond_b
    iget-object v5, p0, Lorg/apache/commons/mail/Email;->bccList:Ljava/util/List;
    ...
    iget-object v7, p0, Lorg/apache/commons/mail/Email;->bccList:Ljava/util/List;
    ...
    .line 1364
    :cond_c
    iget-object v5, p0, Lorg/apache/commons/mail/Email;->replyList:Ljava/util/List;
    ...
    iget-object v6, p0, Lorg/apache/commons/mail/Email;->replyList:Ljava/util/List;

    invoke-virtual {p0, v6}, Lorg/apache/commons/mail/Email;->toInternetAddressArray(Ljava/util/List;)[Ljavax/mail/internet/InternetAddress;

    move-result-object v6

    invoke-virtual {v5, v6}, Ljavax/mail/internet/MimeMessage;->setReplyTo([Ljavax/mail/Address;)V

    .line 1371
    :cond_d
    iget-object v5, p0, Lorg/apache/commons/mail/Email;->headers:Ljava/util/Map;
    ...
    invoke-direct {p0, v5, v6}, Lorg/apache/commons/mail/Email;->createFoldedHeaderValue(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v1

    .line 1376
    .local v1, "foldedValue":Ljava/lang/String;
    iget-object v6, p0, Lorg/apache/commons/mail/Email;->message:Ljavax/mail/internet/MimeMessage;
    ...
    invoke-virtual {v6, v5, v1}, Ljavax/mail/internet/MimeMessage;->addHeader(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_2

    .line 1380
    .end local v0    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Ljava/lang/String;>;"
    .end local v1    # "foldedValue":Ljava/lang/String;
    .end local v2    # "i$":Ljava/util/Iterator;
    :cond_e
    iget-object v5, p0, Lorg/apache/commons/mail/Email;->message:Ljavax/mail/internet/MimeMessage;

    invoke-virtual {v5}, Ljavax/mail/internet/MimeMessage;->getSentDate()Ljava/util/Date;
    ...
    invoke-virtual {v5, v6}, Ljavax/mail/internet/MimeMessage;->setSentDate(Ljava/util/Date;)V

    .line 1385
    :cond_f
    iget-boolean v5, p0, Lorg/apache/commons/mail/Email;->popBeforeSmtp:Z
    ...
    invoke-virtual {v5, v6}, Ljavax/mail/Session;->getStore(Ljava/lang/String;)Ljavax/mail/Store;

    move-result-object v4

    .line 1388
    .local v4, "store":Ljavax/mail/Store;
    iget-object v5, p0, Lorg/apache/commons/mail/Email;->popHost:Ljava/lang/String;

    iget-object v6, p0, Lorg/apache/commons/mail/Email;->popUsername:Ljava/lang/String;

    iget-object v7, p0, Lorg/apache/commons/mail/Email;->popPassword:Ljava/lang/String;

    invoke-virtual {v4, v5, v6, v7}, Ljavax/mail/Store;->connect(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    .catch Ljavax/mail/MessagingException; {:try_start_1 .. :try_end_1} :catch_0

    .line 1395
    .end local v4    # "store":Ljavax/mail/Store;
    :cond_10
    return-void
.end method
...
.method public getMailSession()Ljavax/mail/Session;
    ...
    .prologue
    .line 627
    iget-object v1, p0, Lorg/apache/commons/mail/Email;->session:Ljavax/mail/Session;
    ...
    .line 648
    const-string v2, "mail.smtp.starttls.required"
    ...
    .line 651
    const-string v2, "mail.smtp.sendpartial"
    ...
    .line 653
    const-string v2, "mail.smtps.sendpartial"
...
.method public sendMimeMessage()Ljava/lang/String;
    ...
    .prologue
    .line 1407
    iget-object v2, p0, Lorg/apache/commons/mail/Email;->message:Ljavax/mail/internet/MimeMessage;

    const-string v3, "MimeMessage has not been created yet"

    invoke-static {v2, v3}, Lorg/apache/commons/mail/EmailUtils;->notNull(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Ljavax/mail/internet/MimeMessage;->getMessageID()Ljava/lang/String;
    :try_end_0
    ...
    const-string v3, "Sending the email to the following server failed : "
...
.method public setHeaders(Ljava/util/Map;)V
    ...
    iget-object v2, p0, Lorg/apache/commons/mail/Email;->headers:Ljava/util/Map;
...
.method public setMailSession(Ljavax/mail/Session;)V
    ...
    .prologue
    .line 558
    const-string v4, "no mail session supplied"

    invoke-static {p1, v4}, Lorg/apache/commons/mail/EmailUtils;->notNull(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 561
    .local v2, "sessionProperties":Ljava/util/Properties;
    ...
    .line 565
    const-string v4, "mail.smtp.user"
    ...
    const-string v4, "mail.smtp.password"
    ...
    invoke-direct {v4, v3, v1}, Lorg/apache/commons/mail/DefaultAuthenticator;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, v4}, Ljavax/mail/Session;->getInstance(Ljava/util/Properties;Ljavax/mail/Authenticator;)Ljavax/mail/Session;
...
.method public setMailSessionFromJNDI(Ljava/lang/String;)V
    ...
    const-string v2, "JNDI name missing"
    ...
    .line 612
    .restart local v0    # "ctx":Ljavax/naming/Context;
    :goto_0
...
.method public updateContentType(Ljava/lang/String;)V
    ...
    iput-object v4, p0, Lorg/apache/commons/mail/Email;->contentType:Ljava/lang/String;
    ...
    .line 431
    .local v3, "strMarker":Ljava/lang/String;
    ...
    iput-object v4, p0, Lorg/apache/commons/mail/Email;->charset:Ljava/lang/String;
    ...
    .line 457
    .local v1, "contentTypeBuf":Ljava/lang/StringBuffer;
    const-string v4, "; charset="
