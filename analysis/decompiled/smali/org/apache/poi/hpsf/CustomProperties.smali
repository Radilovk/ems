...
.method private put(Lorg/apache/poi/hpsf/CustomProperty;)Ljava/lang/Object;
    ...
    iget-object v7, p0, Lorg/apache/poi/hpsf/CustomProperties;->dictionaryNameToID:Ljava/util/Map;
    ...
    .line 135
    .local v6, "oldId":Ljava/lang/Long;
    if-eqz v6, :cond_0
    ...
    invoke-virtual {p1, v8, v9}, Lorg/apache/poi/hpsf/CustomProperty;->setID(J)V

    .line 148
    :goto_0
    invoke-virtual {p0, v1, p1}, Lorg/apache/poi/hpsf/CustomProperties;->put(Ljava/lang/String;Lorg/apache/poi/hpsf/CustomProperty;)Lorg/apache/poi/hpsf/CustomProperty;
    ...
    .line 140
    .local v4, "max":J
    iget-object v7, p0, Lorg/apache/poi/hpsf/CustomProperties;->dictionaryIDToName:Ljava/util/Map;
...
.method public containsValue(Ljava/lang/Object;)Z
    ...
    .prologue
    .line 366
    instance-of v2, p1, Lorg/apache/poi/hpsf/CustomProperty;
...
.method public getCodepage()I
    ...
    invoke-virtual {v1}, Lorg/apache/poi/hpsf/CustomProperty;->getID()J
...
.method public put(Ljava/lang/String;Ljava/lang/Boolean;)Ljava/lang/Object;
    ...
    .prologue
    .line 252
    new-instance v1, Lorg/apache/poi/hpsf/MutableProperty;

    invoke-direct {v1}, Lorg/apache/poi/hpsf/MutableProperty;-><init>()V

    .line 253
    .local v1, "p":Lorg/apache/poi/hpsf/MutableProperty;
    const-wide/16 v2, -0x1

    invoke-virtual {v1, v2, v3}, Lorg/apache/poi/hpsf/MutableProperty;->setID(J)V

    .line 254
    const-wide/16 v2, 0xb

    invoke-virtual {v1, v2, v3}, Lorg/apache/poi/hpsf/MutableProperty;->setType(J)V

    .line 255
    invoke-virtual {v1, p2}, Lorg/apache/poi/hpsf/MutableProperty;->setValue(Ljava/lang/Object;)V

    .line 256
    new-instance v0, Lorg/apache/poi/hpsf/CustomProperty;

    invoke-direct {v0, v1, p1}, Lorg/apache/poi/hpsf/CustomProperty;-><init>(Lorg/apache/poi/hpsf/Property;Ljava/lang/String;)V

    .line 257
    .local v0, "cp":Lorg/apache/poi/hpsf/CustomProperty;
    invoke-direct {p0, v0}, Lorg/apache/poi/hpsf/CustomProperties;->put(Lorg/apache/poi/hpsf/CustomProperty;)Ljava/lang/Object;
...
.method public put(Ljava/lang/String;Lorg/apache/poi/hpsf/CustomProperty;)Lorg/apache/poi/hpsf/CustomProperty;
    ...
    iput-boolean v3, p0, Lorg/apache/poi/hpsf/CustomProperties;->isPure:Z
    ...
    const-string v5, ") and custom property\'s name ("
    ...
    .line 100
    .local v2, "oldID":Ljava/lang/Long;
    iget-object v3, p0, Lorg/apache/poi/hpsf/CustomProperties;->dictionaryIDToName:Ljava/util/Map;
    ...
    .line 106
    .local v1, "oldCp":Lorg/apache/poi/hpsf/CustomProperty;
