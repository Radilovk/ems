...
.method private checkSheets(I)V
    ...
    const-string v2, "Sheet number out of bounds!"
...
.method public static createWorkbook()Lorg/apache/poi/hssf/model/InternalWorkbook;
    ...
    const-string v9, "creating new workbook from scratch"
    ...
    const-string v9, "exit create new workbook from scratch"
...
.method public static createWorkbook(Ljava/util/List;)Lorg/apache/poi/hssf/model/InternalWorkbook;
    ...
    const-string v7, "Workbook (readfile) created with reclen="
    ...
    const-string v8, "found workbook eof record at "
...
.method public addSSTString(Lorg/apache/poi/hssf/record/common/UnicodeString;)I
    ...
    const-string v1, "insert to sst string=\'"
...
.method public cloneDrawings(Lorg/apache/poi/hssf/model/InternalSheet;)V
    ...
    invoke-virtual/range {v23 .. v23}, Lorg/apache/poi/hssf/model/DrawingManager2;->getDgg()Lorg/apache/poi/ddf/EscherDggRecord;
    ...
    invoke-virtual/range {v23 .. v23}, Lorg/apache/poi/hssf/model/DrawingManager2;->findNewDrawingGroupId()S
    ...
    .local v13, "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Lorg/apache/poi/ddf/EscherRecord;>;"
    :cond_2
    :goto_0
    ...
    .local v22, "spIt":Ljava/util/Iterator;, "Ljava/util/Iterator<Lorg/apache/poi/ddf/EscherRecord;>;"
    :cond_4
    ...
    .line 2467
    .local v19, "shapeContainer":Lorg/apache/poi/ddf/EscherContainerRecord;
    invoke-virtual/range {v19 .. v19}, Lorg/apache/poi/ddf/EscherContainerRecord;->getChildRecords()Ljava/util/List;
    ...
    check-cast v18, Lorg/apache/poi/ddf/EscherRecord;

    .line 2468
    .local v18, "shapeChildRecord":Lorg/apache/poi/ddf/EscherRecord;
    invoke-virtual/range {v18 .. v18}, Lorg/apache/poi/ddf/EscherRecord;->getRecordId()S

    move-result v17

    .line 2469
    .local v17, "recordId":I
    const/16 v23, -0xff6
    ...
    .line 2470
    check-cast v21, Lorg/apache/poi/ddf/EscherSpRecord;

    .line 2471
    .local v21, "sp":Lorg/apache/poi/ddf/EscherSpRecord;
    move-object/from16 v0, p0
    ...
    .line 2475
    .end local v20    # "shapeId":I
    .end local v21    # "sp":Lorg/apache/poi/ddf/EscherSpRecord;
    :cond_6
    const/16 v23, -0xff5
    ...
    .line 2476
    check-cast v14, Lorg/apache/poi/ddf/EscherOptRecord;

    .line 2477
    .local v14, "opt":Lorg/apache/poi/ddf/EscherOptRecord;
    const/16 v23, 0x104

    move/from16 v0, v23

    invoke-virtual {v14, v0}, Lorg/apache/poi/ddf/EscherOptRecord;->lookup(I)Lorg/apache/poi/ddf/EscherProperty;

    move-result-object v16

    check-cast v16, Lorg/apache/poi/ddf/EscherSimpleProperty;

    .line 2479
    .local v16, "prop":Lorg/apache/poi/ddf/EscherSimpleProperty;
    if-eqz v16, :cond_5

    .line 2480
    invoke-virtual/range {v16 .. v16}, Lorg/apache/poi/ddf/EscherSimpleProperty;->getPropertyValue()I
...
.method public cloneFilter(II)Lorg/apache/poi/hssf/record/NameRecord;
    ...
    .line 2512
    .end local v7    # "r3p":Lorg/apache/poi/ss/formula/ptg/Ref3DPtg;
    :cond_2
    const/16 v8, 0xd
...
.method public createDrawingGroup()V
    ...
    .line 2216
    iget-object v10, p0, Lorg/apache/poi/hssf/model/InternalWorkbook;->drawingManager:Lorg/apache/poi/hssf/model/DrawingManager2;
    ...
    new-instance v8, Lorg/apache/poi/ddf/EscherOptRecord;

    invoke-direct {v8}, Lorg/apache/poi/ddf/EscherOptRecord;-><init>()V

    .line 2220
    .local v8, "opt":Lorg/apache/poi/ddf/EscherOptRecord;
    new-instance v9, Lorg/apache/poi/ddf/EscherSplitMenuColorsRecord;

    invoke-direct {v9}, Lorg/apache/poi/ddf/EscherSplitMenuColorsRecord;-><init>()V

    .line 2222
    .local v9, "splitMenuColors":Lorg/apache/poi/ddf/EscherSplitMenuColorsRecord;
    const/16 v10, -0x1000

    invoke-virtual {v3, v10}, Lorg/apache/poi/ddf/EscherContainerRecord;->setRecordId(S)V

    .line 2223
    const/16 v10, 0xf

    invoke-virtual {v3, v10}, Lorg/apache/poi/ddf/EscherContainerRecord;->setOptions(S)V

    .line 2224
    const/16 v10, -0xffa

    invoke-virtual {v2, v10}, Lorg/apache/poi/ddf/EscherDggRecord;->setRecordId(S)V

    .line 2225
    invoke-virtual {v2, v11}, Lorg/apache/poi/ddf/EscherDggRecord;->setOptions(S)V

    .line 2226
    const/16 v10, 0x400

    invoke-virtual {v2, v10}, Lorg/apache/poi/ddf/EscherDggRecord;->setShapeIdMax(I)V

    .line 2227
    invoke-virtual {v2, v11}, Lorg/apache/poi/ddf/EscherDggRecord;->setNumShapesSaved(I)V

    .line 2228
    invoke-virtual {v2, v11}, Lorg/apache/poi/ddf/EscherDggRecord;->setDrawingsSaved(I)V

    .line 2229
    new-array v10, v11, [Lorg/apache/poi/ddf/EscherDggRecord$FileIdCluster;

    invoke-virtual {v2, v10}, Lorg/apache/poi/ddf/EscherDggRecord;->setFileIdClusters([Lorg/apache/poi/ddf/EscherDggRecord$FileIdCluster;)V

    .line 2230
    new-instance v10, Lorg/apache/poi/hssf/model/DrawingManager2;

    invoke-direct {v10, v2}, Lorg/apache/poi/hssf/model/DrawingManager2;-><init>(Lorg/apache/poi/ddf/EscherDggRecord;)V

    iput-object v10, p0, Lorg/apache/poi/hssf/model/InternalWorkbook;->drawingManager:Lorg/apache/poi/hssf/model/DrawingManager2;
    ...
    invoke-virtual {v0, v10}, Lorg/apache/poi/ddf/EscherContainerRecord;->setRecordId(S)V
    ...
    invoke-virtual {v0, v10}, Lorg/apache/poi/ddf/EscherContainerRecord;->setOptions(S)V
    ...
    invoke-virtual {v8, v10}, Lorg/apache/poi/ddf/EscherOptRecord;->setRecordId(S)V

    .line 2242
    const/16 v10, 0x33

    invoke-virtual {v8, v10}, Lorg/apache/poi/ddf/EscherOptRecord;->setOptions(S)V

    .line 2243
    new-instance v10, Lorg/apache/poi/ddf/EscherBoolProperty;

    const/16 v11, 0xbf

    const v12, 0x80008

    invoke-direct {v10, v11, v12}, Lorg/apache/poi/ddf/EscherBoolProperty;-><init>(SI)V

    invoke-virtual {v8, v10}, Lorg/apache/poi/ddf/EscherOptRecord;->addEscherProperty(Lorg/apache/poi/ddf/EscherProperty;)V

    .line 2244
    new-instance v10, Lorg/apache/poi/ddf/EscherRGBProperty;

    const/16 v11, 0x181

    const v12, 0x8000041

    invoke-direct {v10, v11, v12}, Lorg/apache/poi/ddf/EscherRGBProperty;-><init>(SI)V
    ...
    invoke-virtual {v9, v10}, Lorg/apache/poi/ddf/EscherSplitMenuColorsRecord;->setRecordId(S)V

    .line 2247
    const/16 v10, 0x40

    invoke-virtual {v9, v10}, Lorg/apache/poi/ddf/EscherSplitMenuColorsRecord;->setOptions(S)V

    .line 2248
    const v10, 0x800000d

    invoke-virtual {v9, v10}, Lorg/apache/poi/ddf/EscherSplitMenuColorsRecord;->setColor1(I)V

    .line 2249
    const v10, 0x800000c

    invoke-virtual {v9, v10}, Lorg/apache/poi/ddf/EscherSplitMenuColorsRecord;->setColor2(I)V

    .line 2250
    const v10, 0x8000017

    invoke-virtual {v9, v10}, Lorg/apache/poi/ddf/EscherSplitMenuColorsRecord;->setColor3(I)V

    .line 2251
    const v10, 0x100000f7

    invoke-virtual {v9, v10}, Lorg/apache/poi/ddf/EscherSplitMenuColorsRecord;->setColor4(I)V
    ...
    .line 2257
    invoke-virtual {v3, v9}, Lorg/apache/poi/ddf/EscherContainerRecord;->addChildRecord(Lorg/apache/poi/ddf/EscherRecord;)V

    .line 2259
    const/16 v10, 0xeb

    invoke-virtual {p0, v10}, Lorg/apache/poi/hssf/model/InternalWorkbook;->findFirstRecordLocBySid(S)I
    ...
    invoke-interface {v10, v11, v4}, Ljava/util/List;->add(ILjava/lang/Object;)V
    ...
    .end local v7    # "loc":I
    .end local v8    # "opt":Lorg/apache/poi/ddf/EscherOptRecord;
    .end local v9    # "splitMenuColors":Lorg/apache/poi/ddf/EscherSplitMenuColorsRecord;
    :cond_2
    :goto_1
    return-void
    ...
    .restart local v8    # "opt":Lorg/apache/poi/ddf/EscherOptRecord;
    .restart local v9    # "splitMenuColors":Lorg/apache/poi/ddf/EscherSplitMenuColorsRecord;
    :cond_3
    new-instance v4, Lorg/apache/poi/hssf/record/DrawingGroupRecord;
    ...
    invoke-interface {v10, v1, v4}, Ljava/util/List;->set(ILjava/lang/Object;)Ljava/lang/Object;
...
.method public createStyleRecord(I)Lorg/apache/poi/hssf/record/StyleRecord;
    ...
    const-string v5, "No XF Records found!"
...
.method public doesContainsSheetName(Ljava/lang/String;I)Z
    ...
    .end local v2    # "boundSheetRecord":Lorg/apache/poi/hssf/record/BoundSheetRecord;
    :cond_4
    return v4
.end method
...
.method public findDrawingGroup()Lorg/apache/poi/hssf/model/DrawingManager2;
    ...
    .line 2149
    :cond_0
    iget-object v10, p0, Lorg/apache/poi/hssf/model/InternalWorkbook;->records:Lorg/apache/poi/hssf/model/WorkbookRecordList;

    invoke-virtual {v10}, Lorg/apache/poi/hssf/model/WorkbookRecordList;->iterator()Ljava/util/Iterator;
    ...
    .line 2150
    .local v9, "r":Lorg/apache/poi/hssf/record/Record;
    instance-of v10, v9, Lorg/apache/poi/hssf/record/DrawingGroupRecord;
    ...
    invoke-direct {v10, v5}, Lorg/apache/poi/hssf/model/DrawingManager2;-><init>(Lorg/apache/poi/ddf/EscherDggRecord;)V
    ...
    .end local v9    # "r":Lorg/apache/poi/hssf/record/Record;
    :cond_7
    const/16 v10, 0xeb
    ...
    invoke-virtual {v10, v4}, Lorg/apache/poi/hssf/model/WorkbookRecordList;->get(I)Lorg/apache/poi/hssf/record/Record;
...
.method public findNextRecordBySid(SI)Lorg/apache/poi/hssf/record/Record;
    ...
    .restart local v3    # "record":Lorg/apache/poi/hssf/record/Record;
    :cond_2
    move v1, v2
...
.method public findSheetFirstNameFromExternSheet(I)Ljava/lang/String;
    ...
    invoke-virtual {v1, p1}, Lorg/apache/poi/hssf/model/LinkTable;->getFirstInternalSheetIndexForExtIndex(I)I
...
.method public findSheetLastNameFromExternSheet(I)Ljava/lang/String;
    ...
    invoke-virtual {v1, p1}, Lorg/apache/poi/hssf/model/LinkTable;->getLastInternalSheetIndexForExtIndex(I)I
...
.method public getCustomPalette()Lorg/apache/poi/hssf/record/PaletteRecord;
    ...
    const-string v5, "InternalError: Expected PaletteRecord but got a \'"
...
.method public getExternalName(II)Lorg/apache/poi/ss/formula/EvaluationWorkbook$ExternalName;
    ...
    invoke-virtual {v2, p1, p2, p0}, Lorg/apache/poi/hssf/model/LinkTable;->resolveNameXText(IILorg/apache/poi/hssf/model/InternalWorkbook;)Ljava/lang/String;
...
.method public getExternalSheet(I)Lorg/apache/poi/ss/formula/EvaluationWorkbook$ExternalSheet;
    ...
    invoke-direct {v1, v2, v3, v4}, Lorg/apache/poi/ss/formula/EvaluationWorkbook$ExternalSheetRange;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public getFontIndex(Lorg/apache/poi/hssf/record/FontRecord;)I
    ...
    const-string v3, "Could not find that font!"
...
.method public getFontRecordAt(I)Lorg/apache/poi/hssf/record/FontRecord;
    ...
    const-string v4, "There are only "
    ...
    const-string v4, " font records, you asked for "
...
.method public getSheetIndex(Ljava/lang/String;)I
    ...
    .line 716
    .restart local v2    # "sheet":Ljava/lang/String;
    :cond_1
    add-int/lit8 v0, v0, 0x1
...
.method public insertSST()V
    ...
    const-string v1, "creating new SST via insertSST!"
...
.method public removeSheet(I)V
    ...
    :cond_3
    iget-object v3, p0, Lorg/apache/poi/hssf/model/InternalWorkbook;->linkTable:Lorg/apache/poi/hssf/model/LinkTable;
    ...
    invoke-virtual {v3, v0}, Lorg/apache/poi/hssf/model/LinkTable;->removeSheet(I)V
...
.method public serialize(I[B)I
    ...
    const-string v9, "Serializing Workbook with offsets"
    ...
    const-string v9, "Exiting serialize workbook"
...
.method public setSheetOrder(Ljava/lang/String;I)V
    ...
    invoke-virtual {v3}, Lorg/apache/poi/hssf/model/WorkbookRecordList;->getBspos()I
    ...
    .line 632
    .local v1, "removed":Lorg/apache/poi/hssf/record/Record;
    iget-object v3, p0, Lorg/apache/poi/hssf/model/InternalWorkbook;->records:Lorg/apache/poi/hssf/model/WorkbookRecordList;
    ...
    invoke-virtual {v3, v4, v1}, Lorg/apache/poi/hssf/model/WorkbookRecordList;->add(ILorg/apache/poi/hssf/record/Record;)V
...
.method public updateNameCommentRecordCache(Lorg/apache/poi/hssf/record/NameCommentRecord;)V
    ...
    .line 1999
    .end local v0    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lorg/apache/poi/hssf/record/NameCommentRecord;>;"
