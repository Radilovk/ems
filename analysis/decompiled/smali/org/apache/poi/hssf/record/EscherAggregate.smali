...
.method public static createAggregate(Ljava/util/List;I)Lorg/apache/poi/hssf/record/EscherAggregate;
    ...
    .line 381
    .local v14, "shapeRecords":Ljava/util/List;, "Ljava/util/List<Lorg/apache/poi/ddf/EscherRecord;>;"
    new-instance v11, Lorg/apache/poi/hssf/record/EscherAggregate$1;

    invoke-direct {v11, v14}, Lorg/apache/poi/hssf/record/EscherAggregate$1;-><init>(Ljava/util/List;)V

    .line 392
    .local v11, "recordFactory":Lorg/apache/poi/ddf/EscherRecordFactory;
    ...
    new-instance v2, Lorg/apache/poi/hssf/record/EscherAggregate;

    const/4 v15, 0x0

    invoke-direct {v2, v15}, Lorg/apache/poi/hssf/record/EscherAggregate;-><init>(Z)V
    ...
    invoke-static {v0, v6}, Lorg/apache/poi/hssf/record/EscherAggregate;->sid(Ljava/util/List;I)S

    move-result v15

    invoke-static {v15}, Lorg/apache/poi/hssf/record/EscherAggregate;->isDrawingLayerRecord(S)Z
    ...
    check-cast v15, Lorg/apache/poi/hssf/record/DrawingRecord;

    invoke-virtual {v15}, Lorg/apache/poi/hssf/record/DrawingRecord;->getRecordData()[B
    ...
    check-cast v15, Lorg/apache/poi/hssf/record/ContinueRecord;

    invoke-virtual {v15}, Lorg/apache/poi/hssf/record/ContinueRecord;->getData()[B
    ...
    const-string v16, "Couldn\'t get data from drawing/continue records"
    ...
    invoke-interface {v11, v15, v9}, Lorg/apache/poi/ddf/EscherRecordFactory;->createRecord([BI)Lorg/apache/poi/ddf/EscherRecord;

    move-result-object v10

    .line 418
    .local v10, "r":Lorg/apache/poi/ddf/EscherRecord;
    invoke-virtual {v3}, Ljava/io/ByteArrayOutputStream;->toByteArray()[B

    move-result-object v15

    invoke-virtual {v10, v15, v9, v11}, Lorg/apache/poi/ddf/EscherRecord;->fillFields([BILorg/apache/poi/ddf/EscherRecordFactory;)I

    move-result v4

    .line 419
    .local v4, "bytesRead":I
    invoke-virtual {v2, v10}, Lorg/apache/poi/hssf/record/EscherAggregate;->addEscherRecord(Lorg/apache/poi/ddf/EscherRecord;)Z
    ...
    .end local v10    # "r":Lorg/apache/poi/ddf/EscherRecord;
    :cond_3
    ...
    invoke-static {v0, v6}, Lorg/apache/poi/hssf/record/EscherAggregate;->isObjectRecord(Ljava/util/List;I)Z
    ...
    .line 433
    .local v8, "objRecord":Lorg/apache/poi/hssf/record/Record;
    iget-object v15, v2, Lorg/apache/poi/hssf/record/EscherAggregate;->shapeToObj:Ljava/util/Map;

    add-int/lit8 v13, v12, 0x1

    .end local v12    # "shapeIndex":I
    .local v13, "shapeIndex":I
    ...
    .line 435
    .end local v13    # "shapeIndex":I
    .restart local v12    # "shapeIndex":I
    goto :goto_3

    .line 438
    .end local v8    # "objRecord":Lorg/apache/poi/hssf/record/Record;
    :cond_5
    :goto_4
    invoke-interface/range {p0 .. p0}, Ljava/util/List;->size()I
    ...
    .line 441
    .local v10, "r":Lorg/apache/poi/hssf/record/NoteRecord;
    iget-object v15, v2, Lorg/apache/poi/hssf/record/EscherAggregate;->tailRec:Ljava/util/Map;

    invoke-virtual {v10}, Lorg/apache/poi/hssf/record/NoteRecord;->getShapeId()I
    ...
    .line 448
    .end local v10    # "r":Lorg/apache/poi/hssf/record/NoteRecord;
    :cond_6
    move v7, v6
...
.method private getEscherRecordSize(Ljava/util/List;)I
    ...
    .line 582
    .local v1, "record":Lorg/apache/poi/ddf/EscherRecord;
    ...
    .line 584
    .end local v1    # "record":Lorg/apache/poi/ddf/EscherRecord;
    :cond_0
    return v2
.end method
...
.method private static sid(Ljava/util/List;I)S
    ...
    .end local v0    # "record":Lorg/apache/poi/hssf/record/RecordBase;
    ...
    .restart local v0    # "record":Lorg/apache/poi/hssf/record/RecordBase;
    :cond_0
    const/4 v1, -0x1
...
.method public getRecordSize()I
    ...
    .line 595
    .local v2, "continueRecordsHeadersSize":I
    invoke-virtual/range {p0 .. p0}, Lorg/apache/poi/hssf/record/EscherAggregate;->getEscherRecords()Ljava/util/List;

    move-result-object v12

    .line 596
    .local v12, "records":Ljava/util/List;, "Ljava/util/List<Lorg/apache/poi/ddf/EscherRecord;>;"
    move-object/from16 v0, p0

    invoke-direct {v0, v12}, Lorg/apache/poi/hssf/record/EscherAggregate;->getEscherRecordSize(Ljava/util/List;)I

    move-result v11

    .line 597
    .local v11, "rawEscherSize":I
    new-array v1, v11, [B
    ...
    .line 599
    .local v13, "spEndingOffsets":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Integer;>;"
    const/4 v9, 0x0
    ...
    .line 601
    .local v4, "e":Lorg/apache/poi/ddf/EscherRecord;
    new-instance v15, Lorg/apache/poi/hssf/record/EscherAggregate$3;

    move-object/from16 v0, p0

    invoke-direct {v15, v0, v13}, Lorg/apache/poi/hssf/record/EscherAggregate$3;-><init>(Lorg/apache/poi/hssf/record/EscherAggregate;Ljava/util/List;)V

    invoke-virtual {v4, v9, v1, v15}, Lorg/apache/poi/ddf/EscherRecord;->serialize(I[BLorg/apache/poi/ddf/EscherSerializationListener;)I
    ...
    .line 612
    .end local v4    # "e":Lorg/apache/poi/ddf/EscherRecord;
    :cond_0
    const/4 v15, 0x0
    ...
    invoke-interface {v13, v15, v0}, Ljava/util/List;->add(ILjava/lang/Object;)V
    ...
    iget-object v15, v0, Lorg/apache/poi/hssf/record/EscherAggregate;->shapeToObj:Ljava/util/Map;
    ...
    check-cast v10, Lorg/apache/poi/hssf/record/Record;

    .line 630
    .local v10, "r":Lorg/apache/poi/hssf/record/Record;
    invoke-virtual {v10}, Lorg/apache/poi/hssf/record/Record;->getRecordSize()I
    ...
    .line 632
    .end local v10    # "r":Lorg/apache/poi/hssf/record/Record;
    :cond_5
    const/4 v14, 0x0

    .line 633
    .local v14, "tailRecordSize":I
    move-object/from16 v0, p0

    iget-object v15, v0, Lorg/apache/poi/hssf/record/EscherAggregate;->tailRec:Ljava/util/Map;
    ...
    .line 634
    .local v7, "noteRecord":Lorg/apache/poi/hssf/record/NoteRecord;
    invoke-virtual {v7}, Lorg/apache/poi/hssf/record/NoteRecord;->getRecordSize()I
    ...
    .line 636
    .end local v7    # "noteRecord":Lorg/apache/poi/hssf/record/NoteRecord;
    :cond_6
    add-int v15, v3, v8
...
.method public serialize(I[B)I
    ...
    .line 466
    .local v17, "records":Ljava/util/List;, "Ljava/util/List<Lorg/apache/poi/ddf/EscherRecord;>;"
    move-object/from16 v0, p0
    ...
    .line 471
    .local v20, "spEndingOffsets":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Integer;>;"
    new-instance v18, Ljava/util/ArrayList;

    invoke-direct/range {v18 .. v18}, Ljava/util/ArrayList;-><init>()V

    .line 472
    .local v18, "shapes":Ljava/util/List;, "Ljava/util/List<Lorg/apache/poi/ddf/EscherRecord;>;"
    const/4 v6, 0x0
    ...
    .local v16, "record":Ljava/lang/Object;
    ...
    invoke-direct {v3, v0, v1, v2}, Lorg/apache/poi/hssf/record/EscherAggregate$2;-><init>(Lorg/apache/poi/hssf/record/EscherAggregate;Ljava/util/List;Ljava/util/List;)V

    invoke-virtual {v11, v6, v9, v3}, Lorg/apache/poi/ddf/EscherRecord;->serialize(I[BLorg/apache/poi/ddf/EscherSerializationListener;)I
    ...
    .end local v16    # "record":Ljava/lang/Object;
    :cond_0
    const/4 v3, 0x0
    ...
    .line 511
    .local v14, "obj":Lorg/apache/poi/hssf/record/Record;
    ...
    .end local v14    # "obj":Lorg/apache/poi/hssf/record/Record;
    ...
    .line 527
    .local v15, "rec":Lorg/apache/poi/hssf/record/Record;
    move-object/from16 v0, p2

    invoke-virtual {v15, v6, v0}, Lorg/apache/poi/hssf/record/Record;->serialize(I[B)I
    ...
    .line 529
    .end local v15    # "rec":Lorg/apache/poi/hssf/record/Record;
    :cond_5
    sub-int v10, v6, p1
    ...
    const-string v22, " bytes written but getRecordSize() reports "
