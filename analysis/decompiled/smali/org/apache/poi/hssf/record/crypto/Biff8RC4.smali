...
.method public constructor <init>(ILorg/apache/poi/hssf/record/crypto/Biff8RC4Key;)V
    ...
    .line 59
    iget-object v0, p0, Lorg/apache/poi/hssf/record/crypto/Biff8RC4;->_key:Lorg/apache/poi/hssf/record/crypto/Biff8RC4Key;

    invoke-virtual {v0}, Lorg/apache/poi/hssf/record/crypto/Biff8RC4Key;->getCipher()Ljavax/crypto/Cipher;
    ...
    invoke-direct {p0, v0, v2, p1}, Lorg/apache/poi/hssf/record/crypto/Biff8RC4;->encryptBytes([BII)V
...
.method private encryptBytes([BII)V
    ...
    .line 87
    .end local v6    # "dataCpy":[B
    :cond_1
    :try_start_0
    iget-object v0, p0, Lorg/apache/poi/hssf/record/crypto/Biff8RC4;->_rc4:Ljavax/crypto/Cipher;
    ...
    invoke-direct {v0, v1, v7}, Lorg/apache/poi/EncryptedDocumentException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private rekeyForNextBlock()V
    ...
    iget v2, p0, Lorg/apache/poi/hssf/record/crypto/Biff8RC4;->_currentKeyIndex:I

    invoke-virtual {v0, v1, v2}, Lorg/apache/poi/hssf/record/crypto/Biff8RC4Key;->initCipherForBlock(Ljavax/crypto/Cipher;I)V
...
.method public xor([BII)V
    ...
    .line 148
    invoke-direct {p0, p1, v2, v1}, Lorg/apache/poi/hssf/record/crypto/Biff8RC4;->encryptBytes([BII)V
    ...
    .line 157
    invoke-direct {p0, p1, v2, v5}, Lorg/apache/poi/hssf/record/crypto/Biff8RC4;->encryptBytes([BII)V
    ...
    .line 164
    :cond_3
    invoke-direct {p0, p1, v2, v0}, Lorg/apache/poi/hssf/record/crypto/Biff8RC4;->encryptBytes([BII)V
