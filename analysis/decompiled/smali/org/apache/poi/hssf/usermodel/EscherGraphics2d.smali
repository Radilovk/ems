...
.method public draw(Ljava/awt/Shape;)V
    ...
    .line 145
    check-cast v6, Ljava/awt/geom/Line2D;

    .line 147
    .local v6, "shape2d":Ljava/awt/geom/Line2D;
    const/4 v5, 0x0
    ...
    instance-of v0, v0, Ljava/awt/BasicStroke;
    ...
    mul-int/lit16 v5, v0, 0x319c

    .line 152
    :cond_0
    invoke-virtual {v6}, Ljava/awt/geom/Line2D;->getX1()D

    move-result-wide v0

    double-to-int v1, v0

    invoke-virtual {v6}, Ljava/awt/geom/Line2D;->getY1()D

    move-result-wide v2

    double-to-int v2, v2

    invoke-virtual {v6}, Ljava/awt/geom/Line2D;->getX2()D

    move-result-wide v8

    double-to-int v3, v8

    invoke-virtual {v6}, Ljava/awt/geom/Line2D;->getY2()D
    ...
    invoke-virtual/range {v0 .. v5}, Lorg/apache/poi/hssf/usermodel/EscherGraphics2d;->drawLine(IIIII)V

    .line 159
    .end local v5    # "width":I
    .end local v6    # "shape2d":Ljava/awt/geom/Line2D;
    :cond_1
    :goto_0
    return-void
...
.method public drawImage(Ljava/awt/image/BufferedImage;Ljava/awt/image/BufferedImageOp;II)V
    ...
    .line 222
    invoke-interface {p2, p1, v8}, Ljava/awt/image/BufferedImageOp;->filter(Ljava/awt/image/BufferedImage;Ljava/awt/image/BufferedImage;)Ljava/awt/image/BufferedImage;
    ...
    invoke-direct/range {v0 .. v6}, Ljava/awt/geom/AffineTransform;-><init>(FFFFFF)V

    invoke-virtual {p0, v7, v0, v8}, Lorg/apache/poi/hssf/usermodel/EscherGraphics2d;->drawImage(Ljava/awt/Image;Ljava/awt/geom/AffineTransform;Ljava/awt/image/ImageObserver;)Z
...
.method public drawImage(Ljava/awt/Image;Ljava/awt/geom/AffineTransform;Ljava/awt/image/ImageObserver;)Z
    ...
    invoke-virtual {v1}, Ljava/awt/geom/AffineTransform;->clone()Ljava/lang/Object;
    ...
    .line 215
    invoke-virtual {p0, p1, v2, v2, p3}, Lorg/apache/poi/hssf/usermodel/EscherGraphics2d;->drawImage(Ljava/awt/Image;IILjava/awt/image/ImageObserver;)Z
...
.method public drawPolyline([I[II)V
    ...
    invoke-virtual {v0, v2, v3}, Ljava/awt/geom/GeneralPath;->moveTo(FF)V
...
.method public drawString(Ljava/text/AttributedCharacterIterator;FF)V
    ...
    invoke-direct {v1, p1, v2}, Ljava/awt/font/TextLayout;-><init>(Ljava/text/AttributedCharacterIterator;Ljava/awt/font/FontRenderContext;)V

    .line 301
    .local v1, "textlayout":Ljava/awt/font/TextLayout;
    invoke-virtual {p0}, Lorg/apache/poi/hssf/usermodel/EscherGraphics2d;->getPaint()Ljava/awt/Paint;
    ...
    invoke-virtual {v1, v2}, Ljava/awt/font/TextLayout;->getOutline(Ljava/awt/geom/AffineTransform;)Ljava/awt/Shape;
...
.method public setPaint(Ljava/awt/Paint;)V
    ...
    .end local p1    # "paint1":Ljava/awt/Paint;
