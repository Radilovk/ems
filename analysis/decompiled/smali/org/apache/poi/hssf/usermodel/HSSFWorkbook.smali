...
.method public constructor <init>(Lorg/apache/poi/poifs/filesystem/DirectoryNode;Z)V
    ...
    .prologue
    .line 308
    invoke-direct/range {p0 .. p1}, Lorg/apache/poi/POIDocument;-><init>(Lorg/apache/poi/poifs/filesystem/DirectoryNode;)V

    .line 168
    sget-object v11, Lorg/apache/poi/hssf/usermodel/HSSFRow;->RETURN_NULL_AND_BLANK:Lorg/apache/poi/ss/usermodel/Row$MissingCellPolicy;

    iput-object v11, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->missingCellPolicy:Lorg/apache/poi/ss/usermodel/Row$MissingCellPolicy;

    .line 176
    new-instance v11, Lorg/apache/poi/ss/formula/udf/IndexedUDFFinder;

    const/4 v12, 0x1

    new-array v12, v12, [Lorg/apache/poi/ss/formula/udf/UDFFinder;

    const/4 v13, 0x0

    sget-object v14, Lorg/apache/poi/ss/formula/udf/UDFFinder;->DEFAULT:Lorg/apache/poi/ss/formula/udf/UDFFinder;

    aput-object v14, v12, v13

    invoke-direct {v11, v12}, Lorg/apache/poi/ss/formula/udf/IndexedUDFFinder;-><init>([Lorg/apache/poi/ss/formula/udf/UDFFinder;)V

    iput-object v11, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->_udfFinder:Lorg/apache/poi/ss/formula/udf/UDFFinder;

    .line 309
    invoke-static/range {p1 .. p1}, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->getWorkbookDirEntryName(Lorg/apache/poi/poifs/filesystem/DirectoryNode;)Ljava/lang/String;
    ...
    iput-boolean v0, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->preserveNodes:Z
    ...
    iput-object v11, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->directory:Lorg/apache/poi/poifs/filesystem/DirectoryNode;

    .line 319
    :cond_0
    new-instance v11, Ljava/util/ArrayList;

    sget v12, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->INITIAL_CAPACITY:I

    invoke-direct {v11, v12}, Ljava/util/ArrayList;-><init>(I)V

    iput-object v11, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->_sheets:Ljava/util/List;
    ...
    iput-object v11, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->names:Ljava/util/ArrayList;

    .line 324
    move-object/from16 v0, p1

    invoke-virtual {v0, v10}, Lorg/apache/poi/poifs/filesystem/DirectoryNode;->createDocumentInputStream(Ljava/lang/String;)Lorg/apache/poi/poifs/filesystem/DocumentInputStream;

    move-result-object v9

    .line 326
    .local v9, "stream":Ljava/io/InputStream;
    invoke-static {v9}, Lorg/apache/poi/hssf/record/RecordFactory;->createRecords(Ljava/io/InputStream;)Ljava/util/List;

    move-result-object v6

    .line 328
    .local v6, "records":Ljava/util/List;, "Ljava/util/List<Lorg/apache/poi/hssf/record/Record;>;"
    invoke-static {v6}, Lorg/apache/poi/hssf/model/InternalWorkbook;->createWorkbook(Ljava/util/List;)Lorg/apache/poi/hssf/model/InternalWorkbook;

    move-result-object v11

    iput-object v11, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->workbook:Lorg/apache/poi/hssf/model/InternalWorkbook;

    .line 329
    iget-object v11, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->workbook:Lorg/apache/poi/hssf/model/InternalWorkbook;

    invoke-direct {p0, v11}, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->setPropertiesFromWorkbook(Lorg/apache/poi/hssf/model/InternalWorkbook;)V

    .line 330
    iget-object v11, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->workbook:Lorg/apache/poi/hssf/model/InternalWorkbook;

    invoke-virtual {v11}, Lorg/apache/poi/hssf/model/InternalWorkbook;->getNumRecords()I

    move-result v5

    .line 333
    .local v5, "recOffset":I
    invoke-direct {p0, v6, v5}, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->convertLabelRecords(Ljava/util/List;I)V

    .line 334
    new-instance v7, Lorg/apache/poi/hssf/model/RecordStream;

    invoke-direct {v7, v6, v5}, Lorg/apache/poi/hssf/model/RecordStream;-><init>(Ljava/util/List;I)V

    .line 335
    .local v7, "rs":Lorg/apache/poi/hssf/model/RecordStream;
    :goto_0
    invoke-virtual {v7}, Lorg/apache/poi/hssf/model/RecordStream;->hasNext()Z
    ...
    .line 337
    :try_start_0
    invoke-static {v7}, Lorg/apache/poi/hssf/model/InternalSheet;->createSheet(Lorg/apache/poi/hssf/model/RecordStream;)Lorg/apache/poi/hssf/model/InternalSheet;

    move-result-object v8

    .line 338
    .local v8, "sheet":Lorg/apache/poi/hssf/model/InternalSheet;
    iget-object v11, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->_sheets:Ljava/util/List;

    new-instance v12, Lorg/apache/poi/hssf/usermodel/HSSFSheet;

    invoke-direct {v12, p0, v8}, Lorg/apache/poi/hssf/usermodel/HSSFSheet;-><init>(Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;Lorg/apache/poi/hssf/model/InternalSheet;)V
    ...
    .line 339
    .end local v8    # "sheet":Lorg/apache/poi/hssf/model/InternalSheet;
    :catch_0
    move-exception v1

    .line 341
    .local v1, "eb":Lorg/apache/poi/hssf/model/InternalSheet$UnsupportedBOFType;
    sget-object v11, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->log:Lorg/apache/poi/util/POILogger;
    ...
    const-string v14, "Unsupported BOF found of type "

    invoke-virtual {v13, v14}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v13

    invoke-virtual {v1}, Lorg/apache/poi/hssf/model/InternalSheet$UnsupportedBOFType;->getType()I
    ...
    invoke-virtual {v11, v12, v13}, Lorg/apache/poi/util/POILogger;->log(ILjava/lang/Object;)V

    goto :goto_0

    .line 345
    .end local v1    # "eb":Lorg/apache/poi/hssf/model/InternalSheet$UnsupportedBOFType;
    :cond_1
    const/4 v2, 0x0
    ...
    invoke-virtual {v11}, Lorg/apache/poi/hssf/model/InternalWorkbook;->getNumNames()I
    ...
    invoke-virtual {v11, v2}, Lorg/apache/poi/hssf/model/InternalWorkbook;->getNameRecord(I)Lorg/apache/poi/hssf/record/NameRecord;
    ...
    invoke-virtual {v11, v4}, Lorg/apache/poi/hssf/model/InternalWorkbook;->getNameCommentRecord(Lorg/apache/poi/hssf/record/NameRecord;)Lorg/apache/poi/hssf/record/NameCommentRecord;

    move-result-object v11

    invoke-direct {v3, p0, v4, v11}, Lorg/apache/poi/hssf/usermodel/HSSFName;-><init>(Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;Lorg/apache/poi/hssf/record/NameRecord;Lorg/apache/poi/hssf/record/NameCommentRecord;)V

    .line 348
    .local v3, "name":Lorg/apache/poi/hssf/usermodel/HSSFName;
    iget-object v11, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->names:Ljava/util/ArrayList;
...
.method private getAllEmbeddedObjects(Lorg/apache/poi/hssf/usermodel/HSSFShapeContainer;Ljava/util/List;)V
    ...
    .line 1951
    check-cast v1, Lorg/apache/poi/hssf/usermodel/HSSFObjectData;
    ...
    .line 1952
    .restart local v1    # "shape":Lorg/apache/poi/hssf/usermodel/HSSFShape;
    :cond_1
    ...
    .line 1953
    check-cast v1, Lorg/apache/poi/hssf/usermodel/HSSFShapeContainer;

    .end local v1    # "shape":Lorg/apache/poi/hssf/usermodel/HSSFShape;
    invoke-direct {p0, v1, p2}, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->getAllEmbeddedObjects(Lorg/apache/poi/hssf/usermodel/HSSFShapeContainer;Ljava/util/List;)V
...
.method protected static getOleMap()Ljava/util/Map;
    ...
    .line 1819
    .local v3, "olemap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lorg/apache/poi/hpsf/ClassID;>;"
    const-string v5, "PowerPoint Document"

    sget-object v6, Lorg/apache/poi/hpsf/ClassID;->PPT_SHOW:Lorg/apache/poi/hpsf/ClassID;
...
.method public static getWorkbookDirEntryName(Lorg/apache/poi/poifs/filesystem/DirectoryNode;)Ljava/lang/String;
    ...
    .local v0, "i":I
    :goto_0
    sget-object v2, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->WORKBOOK_DIR_ENTRY_NAMES:[Ljava/lang/String;
    ...
    const-string v3, "The supplied spreadsheet seems to be an Encrypted .xlsx file. It must be decrypted before use by XSSF, it cannot be used by HSSF"
    ...
    const-string v3, "The supplied spreadsheet seems to be Excel 5.0/7.0 (BIFF5) format. POI only supports BIFF8 format (from Excel versions 97/2000/XP/2003)"

    invoke-direct {v2, v3}, Lorg/apache/poi/hssf/OldExcelFormatException;-><init>(Ljava/lang/String;)V
    ...
    const-string v3, "The supplied POIFSFileSystem does not contain a BIFF8 \'Workbook\' entry. Is it really an excel file?"
...
.method private searchForPictures(Ljava/util/List;Ljava/util/List;)V
    ...
    instance-of v4, v1, Lorg/apache/poi/ddf/EscherBSERecord;
    ...
    invoke-direct {v3, v0}, Lorg/apache/poi/hssf/usermodel/HSSFPictureData;-><init>(Lorg/apache/poi/ddf/EscherBlipRecord;)V
    ...
    invoke-direct {p0, v4, p2}, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->searchForPictures(Ljava/util/List;Ljava/util/List;)V
...
.method public addOlePackage(Lorg/apache/poi/poifs/filesystem/POIFSFileSystem;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 1830
    .local v4, "root":Lorg/apache/poi/poifs/filesystem/DirectoryNode;
    ...
    .line 1832
    .local v1, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lorg/apache/poi/hpsf/ClassID;>;"
    ...
    invoke-virtual {v4, v5}, Lorg/apache/poi/poifs/filesystem/DirectoryNode;->hasEntry(Ljava/lang/String;)Z
    ...
    check-cast v5, Lorg/apache/poi/hpsf/ClassID;

    invoke-virtual {v4, v5}, Lorg/apache/poi/poifs/filesystem/DirectoryNode;->setStorageClsid(Lorg/apache/poi/hpsf/ClassID;)V

    .line 1838
    .end local v1    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lorg/apache/poi/hpsf/ClassID;>;"
    :cond_1
    ...
    invoke-virtual {p1, v0}, Lorg/apache/poi/poifs/filesystem/POIFSFileSystem;->writeFilesystem(Ljava/io/OutputStream;)V
    ...
    invoke-virtual {p0, v5, p2, p3, p4}, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->addOlePackage([BLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
...
.method public addOlePackage([BLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    .prologue
    .line 1846
    iget-object v6, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->directory:Lorg/apache/poi/poifs/filesystem/DirectoryNode;
    ...
    iput-object v6, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->directory:Lorg/apache/poi/poifs/filesystem/DirectoryNode;

    .line 1848
    const/4 v6, 0x1

    iput-boolean v6, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->preserveNodes:Z
    ...
    .line 1856
    .local v5, "storageStr":Ljava/lang/String;
    iget-object v6, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->directory:Lorg/apache/poi/poifs/filesystem/DirectoryNode;

    invoke-virtual {v6, v5}, Lorg/apache/poi/poifs/filesystem/DirectoryNode;->hasEntry(Ljava/lang/String;)Z
    ...
    invoke-virtual {v6, v5}, Lorg/apache/poi/poifs/filesystem/DirectoryNode;->createDirectory(Ljava/lang/String;)Lorg/apache/poi/poifs/filesystem/DirectoryEntry;

    move-result-object v2

    .line 1858
    sget-object v6, Lorg/apache/poi/hpsf/ClassID;->OLE10_PACKAGE:Lorg/apache/poi/hpsf/ClassID;

    invoke-interface {v2, v6}, Lorg/apache/poi/poifs/filesystem/DirectoryEntry;->setStorageClsid(Lorg/apache/poi/hpsf/ClassID;)V
    ...
    invoke-interface {v2, v6, v7}, Lorg/apache/poi/poifs/filesystem/DirectoryEntry;->createDocument(Ljava/lang/String;Ljava/io/InputStream;)Lorg/apache/poi/poifs/filesystem/DocumentEntry;
    ...
    .line 1870
    .local v0, "bos":Ljava/io/ByteArrayOutputStream;
    invoke-virtual {v3, v0}, Lorg/apache/poi/poifs/filesystem/Ole10Native;->writeOut(Ljava/io/OutputStream;)V
...
.method public addPicture([BI)I
    ...
    .line 1718
    .local v1, "blipRecordBitmap":Lorg/apache/poi/ddf/EscherBitmapBlip;
    move-object v0, v1

    .line 1719
    .local v0, "blipRecord":Lorg/apache/poi/ddf/EscherBlipRecord;
    invoke-virtual {v1, v7}, Lorg/apache/poi/ddf/EscherBitmapBlip;->setUID([B)V

    .line 1720
    const/4 v8, -0x1

    invoke-virtual {v1, v8}, Lorg/apache/poi/ddf/EscherBitmapBlip;->setMarker(B)V

    .line 1721
    invoke-virtual {v1, p1}, Lorg/apache/poi/ddf/EscherBitmapBlip;->setPictureData([B)V
    ...
    .line 1727
    .end local v1    # "blipRecordBitmap":Lorg/apache/poi/ddf/EscherBitmapBlip;
    .local v4, "escherTag":S
    :goto_0
    add-int/lit16 v8, p2, -0xfe8

    int-to-short v8, v8

    invoke-virtual {v0, v8}, Lorg/apache/poi/ddf/EscherBlipRecord;->setRecordId(S)V
    ...
    .line 1750
    :goto_1
    new-instance v6, Lorg/apache/poi/ddf/EscherBSERecord;

    invoke-direct {v6}, Lorg/apache/poi/ddf/EscherBSERecord;-><init>()V

    .line 1751
    .local v6, "r":Lorg/apache/poi/ddf/EscherBSERecord;
    const/16 v8, -0xff9

    invoke-virtual {v6, v8}, Lorg/apache/poi/ddf/EscherBSERecord;->setRecordId(S)V

    .line 1752
    shl-int/lit8 v8, p2, 0x4

    or-int/lit8 v8, v8, 0x2

    int-to-short v8, v8

    invoke-virtual {v6, v8}, Lorg/apache/poi/ddf/EscherBSERecord;->setOptions(S)V

    .line 1753
    int-to-byte v8, p2

    invoke-virtual {v6, v8}, Lorg/apache/poi/ddf/EscherBSERecord;->setBlipTypeMacOS(B)V

    .line 1754
    int-to-byte v8, p2

    invoke-virtual {v6, v8}, Lorg/apache/poi/ddf/EscherBSERecord;->setBlipTypeWin32(B)V

    .line 1755
    invoke-virtual {v6, v7}, Lorg/apache/poi/ddf/EscherBSERecord;->setUid([B)V

    .line 1756
    invoke-virtual {v6, v4}, Lorg/apache/poi/ddf/EscherBSERecord;->setTag(S)V

    .line 1757
    invoke-virtual {v6, v3}, Lorg/apache/poi/ddf/EscherBSERecord;->setSize(I)V

    .line 1758
    invoke-virtual {v6, v10}, Lorg/apache/poi/ddf/EscherBSERecord;->setRef(I)V

    .line 1759
    invoke-virtual {v6, v10}, Lorg/apache/poi/ddf/EscherBSERecord;->setOffset(I)V

    .line 1760
    invoke-virtual {v6, v0}, Lorg/apache/poi/ddf/EscherBSERecord;->setBlipRecord(Lorg/apache/poi/ddf/EscherBlipRecord;)V

    .line 1762
    iget-object v8, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->workbook:Lorg/apache/poi/hssf/model/InternalWorkbook;

    invoke-virtual {v8, v6}, Lorg/apache/poi/hssf/model/InternalWorkbook;->addBSERecord(Lorg/apache/poi/ddf/EscherBSERecord;)I
    ...
    .line 1700
    .end local v0    # "blipRecord":Lorg/apache/poi/ddf/EscherBlipRecord;
    .end local v3    # "blipSize":I
    .end local v4    # "escherTag":S
    .end local v6    # "r":Lorg/apache/poi/ddf/EscherBSERecord;
    :pswitch_0
    ...
    invoke-static {p1, v8, v5, v10, v9}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    .line 1703
    move-object p1, v5

    .line 1707
    .end local v5    # "picDataNoHeader":[B
    :cond_0
    :pswitch_1
    ...
    .line 1708
    .local v2, "blipRecordMeta":Lorg/apache/poi/ddf/EscherMetafileBlip;
    move-object v0, v2

    .line 1709
    .restart local v0    # "blipRecord":Lorg/apache/poi/ddf/EscherBlipRecord;
    invoke-virtual {v2, v7}, Lorg/apache/poi/ddf/EscherMetafileBlip;->setUID([B)V

    .line 1710
    invoke-virtual {v2, p1}, Lorg/apache/poi/ddf/EscherMetafileBlip;->setPictureData([B)V

    .line 1712
    const/4 v8, -0x2

    invoke-virtual {v2, v8}, Lorg/apache/poi/ddf/EscherMetafileBlip;->setFilter(B)V

    .line 1713
    invoke-virtual {v2}, Lorg/apache/poi/ddf/EscherMetafileBlip;->getCompressedSize()I

    move-result v8

    add-int/lit8 v3, v8, 0x3a

    .line 1714
    .restart local v3    # "blipSize":I
    const/4 v4, 0x0

    .line 1715
    .restart local v4    # "escherTag":S
    goto :goto_0

    .line 1731
    .end local v2    # "blipRecordMeta":Lorg/apache/poi/ddf/EscherMetafileBlip;
    :pswitch_2
    const/16 v8, 0x3d40

    invoke-virtual {v0, v8}, Lorg/apache/poi/ddf/EscherBlipRecord;->setOptions(S)V
...
.method public createCellStyle()Lorg/apache/poi/hssf/usermodel/HSSFCellStyle;
    ...
    const-string v4, "The maximum number of cell styles was exceeded. You can define up to 4000 styles in a .xls workbook"
...
.method public createSheet(Ljava/lang/String;)Lorg/apache/poi/hssf/usermodel/HSSFSheet;
    ...
    const-string v3, "sheetName must not be null"
    ...
    const-string v3, "The workbook already contains a sheet of this name"
...
.method public findFont(SSSLjava/lang/String;ZZSB)Lorg/apache/poi/hssf/usermodel/HSSFFont;
    ...
    .line 1159
    .end local v0    # "hssfFont":Lorg/apache/poi/hssf/usermodel/HSSFFont;
    :goto_1
    return-object v0
...
.method public getAllPictures()Ljava/util/List;
    ...
    .line 1785
    .end local v0    # "escherRecords":Ljava/util/List;, "Ljava/util/List<Lorg/apache/poi/ddf/EscherRecord;>;"
    :cond_1
    return-object v1
.end method
...
.method public getBytes()[B
    ...
    const-string v11, "HSSFWorkbook.getBytes()"
    ...
    const-string v12, "Actual serialized sheet size ("
    ...
    const-string v12, ") differs from pre-calculated size ("
...
.method public getNameIndex(Ljava/lang/String;)I
    ...
    .restart local v1    # "nameName":Ljava/lang/String;
    :cond_0
    add-int/lit8 v0, v0, 0x1
...
.method public removeSheetAt(I)V
    ...
    .line 975
    .local v4, "someOtherSheetIsStillSelected":Z
    const/4 v1, 0x0
    ...
    .line 987
    .end local v1    # "i":I
    .end local v4    # "someOtherSheetIsStillSelected":Z
    :cond_4
    invoke-virtual {p0}, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->getActiveSheetIndex()I
    ...
    .restart local v4    # "someOtherSheetIsStillSelected":Z
    :cond_5
    add-int/lit8 v1, v1, 0x1
    ...
    invoke-virtual {p0, v6}, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->setActiveSheet(I)V
...
.method public setSheetOrder(Ljava/lang/String;I)V
    ...
    invoke-virtual {v5, p1, p2}, Lorg/apache/poi/hssf/model/InternalWorkbook;->setSheetOrder(Ljava/lang/String;I)V

    .line 477
    invoke-static {v2, p2}, Lorg/apache/poi/ss/formula/FormulaShifter;->createForSheetShift(II)Lorg/apache/poi/ss/formula/FormulaShifter;

    move-result-object v4

    .line 478
    .local v4, "shifter":Lorg/apache/poi/ss/formula/FormulaShifter;
    iget-object v5, p0, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->_sheets:Ljava/util/List;
    ...
    invoke-virtual {v5, v4, v6}, Lorg/apache/poi/hssf/model/InternalSheet;->updateFormulasAfterCellShift(Lorg/apache/poi/ss/formula/FormulaShifter;I)V
    ...
    invoke-virtual {v5, v4}, Lorg/apache/poi/hssf/model/InternalWorkbook;->updateNamesAfterCellShift(Lorg/apache/poi/ss/formula/FormulaShifter;)V
    ...
    invoke-virtual {p0, v5}, Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;->setActiveSheet(I)V
...
.method public write(Ljava/io/OutputStream;)V
    ...
    invoke-virtual {v2, v3, v4}, Lorg/apache/poi/poifs/filesystem/POIFSFileSystem;->createDocument(Ljava/io/InputStream;Ljava/lang/String;)Lorg/apache/poi/poifs/filesystem/DocumentEntry;
    ...
    invoke-direct {v3, v4, v1}, Lorg/apache/poi/poifs/filesystem/FilteringDirectoryNode;-><init>(Lorg/apache/poi/poifs/filesystem/DirectoryEntry;Ljava/util/Collection;)V
    ...
    invoke-direct {v4, v5, v1}, Lorg/apache/poi/poifs/filesystem/FilteringDirectoryNode;-><init>(Lorg/apache/poi/poifs/filesystem/DirectoryEntry;Ljava/util/Collection;)V
