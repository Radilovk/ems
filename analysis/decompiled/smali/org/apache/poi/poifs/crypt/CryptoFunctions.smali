...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/apache/poi/poifs/crypt/CryptoFunctions;->InitialCodeArray:[I
    ...
    sput-object v0, Lorg/apache/poi/poifs/crypt/CryptoFunctions;->PadArray:[B
...
.method public static createXorArray1(Ljava/lang/String;)[B
    ...
    .line 490
    .local v4, "passBytes":[B
    const/16 v6, 0x10

    new-array v3, v6, [B

    .line 491
    .local v3, "obfuscationArray":[B
    array-length v6, v4

    invoke-static {v4, v10, v3, v10, v6}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    .line 492
    sget-object v6, Lorg/apache/poi/poifs/crypt/CryptoFunctions;->PadArray:[B

    array-length v7, v4

    sget-object v8, Lorg/apache/poi/poifs/crypt/CryptoFunctions;->PadArray:[B
    ...
    invoke-static {v6, v10, v3, v7, v8}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-static {v6, v2}, Lorg/apache/poi/poifs/crypt/CryptoFunctions;->rotateLeft(BI)B
...
.method public static createXorVerifier2(Ljava/lang/String;)I
    ...
    .line 356
    .local v1, "generatedKey":[B
    const/16 v8, 0xf

    .line 358
    .local v8, "maxPasswordLength":I
    const-string v11, ""
    ...
    .line 377
    .end local v2    # "highByte":B
    .end local v6    # "intTemp":I
    .end local v7    # "lowByte":B
    :cond_1
    sget-object v11, Lorg/apache/poi/poifs/crypt/CryptoFunctions;->InitialCodeArray:[I
    ...
    .line 387
    sget-object v11, Lorg/apache/poi/poifs/crypt/CryptoFunctions;->EncryptionMatrix:[[I
    ...
    .line 395
    .end local v5    # "intBit":I
    .end local v9    # "tmp":I
    :cond_4
    const/4 v10, 0x0

    .line 398
    .local v10, "verifier":S
    array-length v11, v0
    ...
    .line 400
    invoke-static {v10}, Lorg/apache/poi/poifs/crypt/CryptoFunctions;->rotateLeftBase15Bit(S)S
    ...
    .line 415
    invoke-static {v1, v13, v10}, Lorg/apache/poi/util/LittleEndian;->putShort([BIS)V
    ...
    invoke-static {v1, v11, v12}, Lorg/apache/poi/util/LittleEndian;->putShort([BIS)V

    .line 419
    .end local v0    # "arrByteChars":[B
    .end local v3    # "highOrderWord":I
    .end local v4    # "i":I
    .end local v10    # "verifier":S
    :cond_6
...
.method public static generateIv(Lorg/apache/poi/poifs/crypt/HashAlgorithm;[B[BI)[B
    ...
    .line 147
    .end local v0    # "hashAlgo":Ljava/security/MessageDigest;
    :cond_0
...
.method public static getCipher(Ljava/security/Key;Lorg/apache/poi/poifs/crypt/CipherAlgorithm;Lorg/apache/poi/poifs/crypt/ChainingMode;[BILjava/lang/String;)Ljavax/crypto/Cipher;
    ...
    :cond_0
    :try_start_0
    iget-object v4, p1, Lorg/apache/poi/poifs/crypt/CipherAlgorithm;->jceId:Ljava/lang/String;
    ...
    const-string v5, "Export Restrictions in place - please install JCE Unlimited Strength Jurisdiction Policy files"
    ...
    invoke-direct {v4, v2}, Lorg/apache/poi/EncryptedDocumentException;-><init>(Ljava/lang/Throwable;)V
    ...
    :cond_1
    :try_start_1
    sget-object v4, Lorg/apache/poi/poifs/crypt/CipherAlgorithm;->rc4:Lorg/apache/poi/poifs/crypt/CipherAlgorithm;
    ...
    :cond_2
    iget-boolean v4, p1, Lorg/apache/poi/poifs/crypt/CipherAlgorithm;->needsBouncyCastle:Z
    ...
    iget-object v5, p1, Lorg/apache/poi/poifs/crypt/CipherAlgorithm;->jceId:Ljava/lang/String;
    ...
    iget-object v5, p2, Lorg/apache/poi/poifs/crypt/ChainingMode;->jceId:Ljava/lang/String;
    ...
    .line 224
    :cond_4
    sget-object v4, Lorg/apache/poi/poifs/crypt/CipherAlgorithm;->rc2:Lorg/apache/poi/poifs/crypt/CipherAlgorithm;
    ...
    invoke-direct {v0, v4, p3}, Ljavax/crypto/spec/RC2ParameterSpec;-><init>(I[B)V

    .line 229
    .local v0, "aps":Ljava/security/spec/AlgorithmParameterSpec;
    :goto_2
    invoke-virtual {v1, p4, p0, v0}, Ljavax/crypto/Cipher;->init(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V

    goto :goto_1

    .line 227
    .end local v0    # "aps":Ljava/security/spec/AlgorithmParameterSpec;
    :cond_5
    ...
    .restart local v0    # "aps":Ljava/security/spec/AlgorithmParameterSpec;
    goto :goto_2
.end method
...
.method public static getMac(Lorg/apache/poi/poifs/crypt/HashAlgorithm;)Ljavax/crypto/Mac;
    ...
    .line 285
    :try_start_0
    iget-boolean v1, p0, Lorg/apache/poi/poifs/crypt/HashAlgorithm;->needsBouncyCastle:Z
    ...
    .line 287
    iget-object v1, p0, Lorg/apache/poi/poifs/crypt/HashAlgorithm;->jceHmacId:Ljava/lang/String;

    const-string v2, "BC"

    invoke-static {v1, v2}, Ljavax/crypto/Mac;->getInstance(Ljava/lang/String;Ljava/lang/String;)Ljavax/crypto/Mac;
...
.method public static getMessageDigest(Lorg/apache/poi/poifs/crypt/HashAlgorithm;)Ljava/security/MessageDigest;
    ...
    .line 274
    iget-object v1, p0, Lorg/apache/poi/poifs/crypt/HashAlgorithm;->jceId:Ljava/lang/String;
...
.method public static hashPassword(Ljava/lang/String;Lorg/apache/poi/poifs/crypt/HashAlgorithm;[BIZ)[B
    ...
    :try_start_0
    invoke-static {v5, v7, v4}, Lorg/apache/poi/util/LittleEndian;->putInt([BII)V
    ...
    invoke-virtual {v3, v2, v7, v8}, Ljava/security/MessageDigest;->digest([BII)I
    :try_end_0
    ...
    const-string v8, "error in password hashing"
...
.method public static registerBouncyCastle()V
    ...
    .line 307
    .local v0, "bcProviderName":Ljava/lang/String;
    ...
    .line 300
    .end local v0    # "bcProviderName":Ljava/lang/String;
    ...
    .line 302
    .restart local v0    # "bcProviderName":Ljava/lang/String;
    invoke-virtual {v1, v0}, Ljava/lang/ClassLoader;->loadClass(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v2

    .line 303
    .restart local v2    # "clazz":Ljava/lang/Class;, "Ljava/lang/Class<Ljava/security/Provider;>;"
    ...
    const-string v5, "Only the BouncyCastle provider supports your encryption settings - please add it to the classpath."
...
.method private static rotateLeftBase15Bit(S)S
    ...
    .line 520
    .end local v0    # "intermediate1":S
    .end local v1    # "intermediate2":S
    .end local v2    # "intermediate3":S
    :cond_0
    const/4 v3, 0x1
...
.method public static xorHashPasswordReversed(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 437
    .local v0, "hashedPassword":I
    const-string v1, "%1$02X%2$02X%3$02X%4$02X"
