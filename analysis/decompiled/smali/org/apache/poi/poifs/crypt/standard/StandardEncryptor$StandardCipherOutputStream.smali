...
.method protected constructor <init>(Lorg/apache/poi/poifs/crypt/standard/StandardEncryptor;Lorg/apache/poi/poifs/filesystem/DirectoryNode;)V
    ...
    invoke-direct {p0, v2}, Ljava/io/FilterOutputStream;-><init>(Ljava/io/OutputStream;)V
    ...
    .line 131
    const-string v2, "encrypted_package"
    ...
    iput-object v2, p0, Lorg/apache/poi/poifs/crypt/standard/StandardEncryptor$StandardCipherOutputStream;->fileOut:Ljava/io/File;
    ...
    .line 144
    .local v1, "rawStream":Ljava/io/FileOutputStream;
    ...
    .line 146
    .local v0, "cryptStream":Ljavax/crypto/CipherOutputStream;
    iput-object v0, p0, Lorg/apache/poi/poifs/crypt/standard/StandardEncryptor$StandardCipherOutputStream;->out:Ljava/io/OutputStream;
...
.method public processPOIFSWriterEvent(Lorg/apache/poi/poifs/filesystem/POIFSWriterEvent;)V
    ...
    invoke-direct {v2, v3}, Lorg/apache/poi/util/LittleEndianOutputStream;-><init>(Ljava/io/OutputStream;)V

    .line 181
    .local v2, "leos":Lorg/apache/poi/util/LittleEndianOutputStream;
    iget-wide v4, p0, Lorg/apache/poi/poifs/crypt/standard/StandardEncryptor$StandardCipherOutputStream;->countBytes:J

    invoke-virtual {v2, v4, v5}, Lorg/apache/poi/util/LittleEndianOutputStream;->writeLong(J)V

    .line 183
    new-instance v1, Ljava/io/FileInputStream;

    iget-object v3, p0, Lorg/apache/poi/poifs/crypt/standard/StandardEncryptor$StandardCipherOutputStream;->fileOut:Ljava/io/File;

    invoke-direct {v1, v3}, Ljava/io/FileInputStream;-><init>(Ljava/io/File;)V

    .line 184
    .local v1, "fis":Ljava/io/FileInputStream;
    invoke-static {v1, v2}, Lorg/apache/poi/util/IOUtils;->copy(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    .line 188
    invoke-virtual {v2}, Lorg/apache/poi/util/LittleEndianOutputStream;->close()V
    :try_end_0
    ...
    .end local v2    # "leos":Lorg/apache/poi/util/LittleEndianOutputStream;
    :catch_0
    move-exception v0
    ...
    invoke-direct {v3, v0}, Lorg/apache/poi/EncryptedDocumentException;-><init>(Ljava/lang/Throwable;)V
...
.method writeToPOIFS()V
    ...
    .line 169
    .local v0, "oleStreamSize":I
    iget-object v1, p0, Lorg/apache/poi/poifs/crypt/standard/StandardEncryptor$StandardCipherOutputStream;->dir:Lorg/apache/poi/poifs/filesystem/DirectoryNode;

    const-string v2, "EncryptedPackage"

    invoke-virtual {v1, v2, v0, p0}, Lorg/apache/poi/poifs/filesystem/DirectoryNode;->createDocument(Ljava/lang/String;ILorg/apache/poi/poifs/filesystem/POIFSWriterListener;)Lorg/apache/poi/poifs/filesystem/DocumentEntry;
