...
.method private static buildProperties(Ljava/util/Iterator;Lorg/apache/poi/poifs/common/POIFSBigBlockSize;)Ljava/util/List;
    ...
    .local v1, "data":[B
    :goto_1
    invoke-static {v1, v2}, Lorg/apache/poi/poifs/property/PropertyFactory;->convertToProperties([BLjava/util/List;)V
    ...
    const-string v6, "Short Property Block, "
    ...
    const-string v9, " bytes instead of the expected "
    ...
    invoke-virtual {v0, v1, v4, v3}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;
...
.method public preWrite()V
    ...
    .line 132
    .local v4, "pList":Ljava/util/List;, "Ljava/util/List<Lorg/apache/poi/poifs/property/Property;>;"
    const/4 v0, 0x0

    .line 133
    .local v0, "i":I
    iget-object v5, p0, Lorg/apache/poi/poifs/property/NPropertyTable;->_properties:Ljava/util/List;
    ...
    .end local v0    # "i":I
    .local v1, "i":I
    invoke-virtual {v3, v0}, Lorg/apache/poi/poifs/property/Property;->setIndex(I)V
...
.method public write(Lorg/apache/poi/poifs/filesystem/NPOIFSStream;)V
    ...
    iget-object v3, p0, Lorg/apache/poi/poifs/property/NPropertyTable;->_properties:Ljava/util/List;
    ...
    .line 151
    invoke-virtual {v2, v1}, Lorg/apache/poi/poifs/property/Property;->writeData(Ljava/io/OutputStream;)V
    ...
    invoke-virtual {p0, v3}, Lorg/apache/poi/poifs/property/NPropertyTable;->setStartBlock(I)V
