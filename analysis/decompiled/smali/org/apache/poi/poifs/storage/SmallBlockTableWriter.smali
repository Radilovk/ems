...
.method public constructor <init>(Lorg/apache/poi/poifs/common/POIFSBigBlockSize;Ljava/util/List;Lorg/apache/poi/poifs/property/RootProperty;)V
    ...
    .line 58
    new-instance v4, Lorg/apache/poi/poifs/storage/BlockAllocationTableWriter;

    invoke-direct {v4, p1}, Lorg/apache/poi/poifs/storage/BlockAllocationTableWriter;-><init>(Lorg/apache/poi/poifs/common/POIFSBigBlockSize;)V

    iput-object v4, p0, Lorg/apache/poi/poifs/storage/SmallBlockTableWriter;->_sbat:Lorg/apache/poi/poifs/storage/BlockAllocationTableWriter;
    ...
    iput-object v4, p0, Lorg/apache/poi/poifs/storage/SmallBlockTableWriter;->_small_blocks:Ljava/util/List;
    ...
    .line 70
    iget-object v4, p0, Lorg/apache/poi/poifs/storage/SmallBlockTableWriter;->_sbat:Lorg/apache/poi/poifs/storage/BlockAllocationTableWriter;

    array-length v5, v0

    invoke-virtual {v4, v5}, Lorg/apache/poi/poifs/storage/BlockAllocationTableWriter;->allocateSpace(I)I

    move-result v4

    invoke-virtual {v1, v4}, Lorg/apache/poi/poifs/filesystem/POIFSDocument;->setStartBlock(I)V
    ...
    invoke-virtual {v4}, Lorg/apache/poi/poifs/storage/BlockAllocationTableWriter;->simpleCreateBlocks()V

    .line 80
    iget-object v4, p0, Lorg/apache/poi/poifs/storage/SmallBlockTableWriter;->_root:Lorg/apache/poi/poifs/property/RootProperty;

    iget-object v5, p0, Lorg/apache/poi/poifs/storage/SmallBlockTableWriter;->_small_blocks:Ljava/util/List;

    invoke-interface {v5}, Ljava/util/List;->size()I

    move-result v5

    invoke-virtual {v4, v5}, Lorg/apache/poi/poifs/property/RootProperty;->setSize(I)V

    .line 81
    iget-object v4, p0, Lorg/apache/poi/poifs/storage/SmallBlockTableWriter;->_small_blocks:Ljava/util/List;

    invoke-static {p1, v4}, Lorg/apache/poi/poifs/storage/SmallDocumentBlock;->fill(Lorg/apache/poi/poifs/common/POIFSBigBlockSize;Ljava/util/List;)I

    move-result v4

    iput v4, p0, Lorg/apache/poi/poifs/storage/SmallBlockTableWriter;->_big_block_count:I
