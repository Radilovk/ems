...
.method private getSharedSheet(Ljava/lang/String;)Lorg/apache/poi/ss/formula/eval/forked/ForkedEvaluationSheet;
    ...
    .end local v0    # "result":Lorg/apache/poi/ss/formula/eval/forked/ForkedEvaluationSheet;
    ...
    .line 66
    .restart local v0    # "result":Lorg/apache/poi/ss/formula/eval/forked/ForkedEvaluationSheet;
    iget-object v1, p0, Lorg/apache/poi/ss/formula/eval/forked/ForkedEvaluationWorkbook;->_sharedSheetsByName:Ljava/util/Map;
...
.method public copyUpdatedCells(Lorg/apache/poi/ss/usermodel/Workbook;)V
    ...
    .line 73
    .local v4, "sheetNames":[Ljava/lang/String;
    iget-object v5, p0, Lorg/apache/poi/ss/formula/eval/forked/ForkedEvaluationWorkbook;->_sharedSheetsByName:Ljava/util/Map;
    ...
    new-array v1, v5, [Lorg/apache/poi/ss/formula/eval/forked/ForkedEvaluationWorkbook$OrderedSheet;
    ...
    new-instance v5, Lorg/apache/poi/ss/formula/eval/forked/ForkedEvaluationWorkbook$OrderedSheet;

    iget-object v6, p0, Lorg/apache/poi/ss/formula/eval/forked/ForkedEvaluationWorkbook;->_masterBook:Lorg/apache/poi/ss/formula/EvaluationWorkbook;

    invoke-interface {v6, v3}, Lorg/apache/poi/ss/formula/EvaluationWorkbook;->getSheetIndex(Ljava/lang/String;)I

    move-result v6

    invoke-direct {v5, v3, v6}, Lorg/apache/poi/ss/formula/eval/forked/ForkedEvaluationWorkbook$OrderedSheet;-><init>(Ljava/lang/String;I)V
    ...
    invoke-virtual {v5}, Lorg/apache/poi/ss/formula/eval/forked/ForkedEvaluationWorkbook$OrderedSheet;->getSheetName()Ljava/lang/String;
    ...
    check-cast v2, Lorg/apache/poi/ss/formula/eval/forked/ForkedEvaluationSheet;

    .line 82
    .local v2, "sheet":Lorg/apache/poi/ss/formula/eval/forked/ForkedEvaluationSheet;
    ...
    invoke-virtual {v2, v5}, Lorg/apache/poi/ss/formula/eval/forked/ForkedEvaluationSheet;->copyUpdatedCells(Lorg/apache/poi/ss/usermodel/Sheet;)V
    ...
    .line 84
    .end local v2    # "sheet":Lorg/apache/poi/ss/formula/eval/forked/ForkedEvaluationSheet;
    .end local v3    # "sheetName":Ljava/lang/String;
    :cond_1
    return-void
.end method
...
.method public getSheetIndex(Lorg/apache/poi/ss/formula/EvaluationSheet;)I
    ...
    .prologue
    .line 125
    instance-of v1, p1, Lorg/apache/poi/ss/formula/eval/forked/ForkedEvaluationSheet;
