...
.method public static create(Ljava/math/BigInteger;I)Lorg/apache/poi/ss/util/NormalisedDecimal;
    ...
    invoke-direct {v0, p0, p1}, Lorg/apache/poi/ss/util/MutableFPNumber;-><init>(Ljava/math/BigInteger;I)V
    ...
    invoke-virtual {v0, v3}, Lorg/apache/poi/ss/util/MutableFPNumber;->multiplyByPowerOfTen(I)V

    .line 94
    :cond_1
    invoke-virtual {v0}, Lorg/apache/poi/ss/util/MutableFPNumber;->get64BitNormalisedExponent()I
    ...
    const-string v5, "Bad binary exp "
    ...
    .line 87
    .end local v0    # "cc":Lorg/apache/poi/ss/util/MutableFPNumber;
    .end local v1    # "pow10":I
    :cond_2
    const/4 v1, 0x0

    .restart local v1    # "pow10":I
    goto :goto_0

    .line 96
    .restart local v0    # "cc":Lorg/apache/poi/ss/util/MutableFPNumber;
    :pswitch_0
    invoke-virtual {v0}, Lorg/apache/poi/ss/util/MutableFPNumber;->isAboveMinRep()Z
    ...
    .line 121
    invoke-virtual {v0, v1}, Lorg/apache/poi/ss/util/MutableFPNumber;->createNormalisedDecimal(I)Lorg/apache/poi/ss/util/NormalisedDecimal;
    ...
    .line 108
    :pswitch_3
    invoke-virtual {v0}, Lorg/apache/poi/ss/util/MutableFPNumber;->isBelowMaxRep()Z
...
.method public compareNormalised(Lorg/apache/poi/ss/util/NormalisedDecimal;)I
    ...
    iget v2, p1, Lorg/apache/poi/ss/util/NormalisedDecimal;->_relativeDecimalExponent:I
    ...
    :cond_0
    iget-wide v2, p0, Lorg/apache/poi/ss/util/NormalisedDecimal;->_wholePart:J

    iget-wide v4, p1, Lorg/apache/poi/ss/util/NormalisedDecimal;->_wholePart:J
...
.method public getSignificantDecimalDigitsLastDigitRounded()Ljava/lang/String;
    ...
    .prologue
    .line 213
    iget-wide v4, p0, Lorg/apache/poi/ss/util/NormalisedDecimal;->_wholePart:J
...
.method public roundUnits()Lorg/apache/poi/ss/util/NormalisedDecimal;
    ...
    .line 136
    new-instance v1, Lorg/apache/poi/ss/util/NormalisedDecimal;

    invoke-direct {v1, v2, v3, v7, v0}, Lorg/apache/poi/ss/util/NormalisedDecimal;-><init>(JII)V
    ...
    invoke-direct {v1, v4, v5, v7, v6}, Lorg/apache/poi/ss/util/NormalisedDecimal;-><init>(JII)V
