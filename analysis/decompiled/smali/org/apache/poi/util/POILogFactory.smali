...
.method public static getLogger(Ljava/lang/String;)Lorg/apache/poi/util/POILogger;
    ...
    sget-object v5, Lorg/apache/poi/util/POILogFactory;->_loggerClassName:Ljava/lang/String;

    if-nez v5, :cond_0

    .line 92
    :try_start_0
    const-string v5, "org.apache.poi.util.POILogger"

    invoke-static {v5}, Ljava/lang/System;->getProperty(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    sput-object v5, Lorg/apache/poi/util/POILogFactory;->_loggerClassName:Ljava/lang/String;
    :try_end_0
    ...
    sget-object v6, Lorg/apache/poi/util/POILogFactory;->_nullLogger:Lorg/apache/poi/util/POILogger;
    ...
    .local v3, "logger":Lorg/apache/poi/util/POILogger;
    :goto_1
    return-object v5

    .line 111
    .end local v3    # "logger":Lorg/apache/poi/util/POILogger;
    .restart local v2    # "logger":Lorg/apache/poi/util/POILogger;
    :cond_1
    sget-object v5, Lorg/apache/poi/util/POILogFactory;->_loggers:Ljava/util/Map;
    ...
    .end local v2    # "logger":Lorg/apache/poi/util/POILogger;
    .restart local v3    # "logger":Lorg/apache/poi/util/POILogger;
    move-object v5, v2
    ...
    .line 118
    .local v4, "loggerClass":Ljava/lang/Class;, "Ljava/lang/Class<+Lorg/apache/poi/util/POILogger;>;"
    ...
    .line 126
    .end local v4    # "loggerClass":Ljava/lang/Class;, "Ljava/lang/Class<+Lorg/apache/poi/util/POILogger;>;"
    :goto_3
    sget-object v5, Lorg/apache/poi/util/POILogFactory;->_loggers:Ljava/util/Map;
