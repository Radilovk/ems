...
.method static synthetic access$100(Lcom/clj/fastble/scan/BleScanner;)Lcom/clj/fastble/scan/BleScanPresenter;
    .locals 1
    .param p0, "x0"    # Lcom/clj/fastble/scan/BleScanner;
...
.method private declared-synchronized startLeScan([Ljava/util/UUID;[Ljava/lang/String;Ljava/lang/String;ZZJLcom/clj/fastble/callback/BleScanPresenterImp;)V
    ...
    .param p4, "fuzzy"    # Z
    .param p5, "needConnect"    # Z
    .param p6, "timeOut"    # J
    .param p8, "imp"    # Lcom/clj/fastble/callback/BleScanPresenterImp;
    ...
    .line 117
    .end local p0    # "this":Lcom/clj/fastble/scan/BleScanner;
    :cond_0
    monitor-exit p0
    ...
    invoke-virtual {v2}, Lcom/clj/fastble/BleManager;->getBluetoothAdapter()Landroid/bluetooth/BluetoothAdapter;

    move-result-object v2

    iget-object v3, v1, Lcom/clj/fastble/scan/BleScanner;->mBleScanPresenter:Lcom/clj/fastble/scan/BleScanPresenter;

    .line 123
    move-object v4, p1

    invoke-virtual {v2, p1, v3}, Landroid/bluetooth/BluetoothAdapter;->startLeScan([Ljava/util/UUID;Landroid/bluetooth/BluetoothAdapter$LeScanCallback;)Z
    ...
    :goto_0
    iput-object v3, v1, Lcom/clj/fastble/scan/BleScanner;->mBleScanState:Lcom/clj/fastble/data/BleScanState;

    .line 125
    iget-object v3, v1, Lcom/clj/fastble/scan/BleScanner;->mBleScanPresenter:Lcom/clj/fastble/scan/BleScanPresenter;

    invoke-virtual {v3, v2}, Lcom/clj/fastble/scan/BleScanPresenter;->notifyScanStarted(Z)V
    :try_end_1
    ...
    .end local p1    # "serviceUuids":[Ljava/util/UUID;
    .end local p2    # "names":[Ljava/lang/String;
    .end local p3    # "mac":Ljava/lang/String;
    .end local p4    # "fuzzy":Z
    .end local p5    # "needConnect":Z
    .end local p6    # "timeOut":J
    .end local p8    # "imp":Lcom/clj/fastble/callback/BleScanPresenterImp;
    :catchall_0
    move-exception v0
...
.method public scan([Ljava/util/UUID;[Ljava/lang/String;Ljava/lang/String;ZJLcom/clj/fastble/callback/BleScanCallback;)V
    ...
    .param p4, "fuzzy"    # Z
    .param p5, "timeOut"    # J
    .param p7, "callback"    # Lcom/clj/fastble/callback/BleScanCallback;
...
.method public scanAndConnect([Ljava/util/UUID;[Ljava/lang/String;Ljava/lang/String;ZJLcom/clj/fastble/callback/BleScanAndConnectCallback;)V
    ...
    .param p4, "fuzzy"    # Z
    .param p5, "timeOut"    # J
    .param p7, "callback"    # Lcom/clj/fastble/callback/BleScanAndConnectCallback;
