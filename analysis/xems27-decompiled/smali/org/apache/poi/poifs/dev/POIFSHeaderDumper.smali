...
.method public static displayBATReader(Lorg/apache/poi/poifs/storage/BlockAllocationTableReader;)V
    ...
    .line 134
    .local v1, "entries":Lorg/apache/poi/util/IntList;
    const/4 v2, 0x0

    .local v2, "i":I
    :goto_0
    invoke-virtual {v1}, Lorg/apache/poi/util/IntList;->size()I
    ...
    .line 135
    invoke-virtual {v1, v2}, Lorg/apache/poi/util/IntList;->get(I)I
    ...
    .line 137
    .local v4, "bnS":Ljava/lang/String;
    const/4 v5, -0x2

    if-ne v3, v5, :cond_0

    .line 138
    const-string v4, "End Of Chain"
    ...
    .line 142
    const-string v4, "Normal Fat Block"
    ...
    .line 144
    const-string v4, "Block Not Used (Free)"
    ...
    .line 134
    .end local v3    # "bn":I
    .end local v4    # "bnS":Ljava/lang/String;
...
.method public static displayRawBlocksSummary(Lorg/apache/poi/poifs/storage/RawDataBlockList;)V
    ...
    .line 114
    .local v0, "gbm":Ljava/lang/reflect/Method;
    ...
    .line 118
    .local v3, "block":Lorg/apache/poi/poifs/storage/ListManagedBlock;
    const/16 v5, 0x30
    ...
    invoke-static {v5, v7, v8, v4}, Lorg/apache/poi/util/HexDump;->dump([BJI)Ljava/lang/String;
    ...
    .line 116
    .end local v3    # "block":Lorg/apache/poi/poifs/storage/ListManagedBlock;
    .end local v5    # "data":[B
    add-int/lit8 v2, v2, 0x1
...
.method public static viewFile(Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lorg/apache/poi/poifs/dev/POIFSHeaderDumper;->displayBATReader(Lorg/apache/poi/poifs/storage/BlockAllocationTableReader;)V
    ...
    invoke-static {v2, v3, v6, v7}, Lorg/apache/poi/poifs/storage/SmallBlockTableReader;->getSmallDocumentBlocks(Lorg/apache/poi/poifs/common/POIFSBigBlockSize;Lorg/apache/poi/poifs/storage/RawDataBlockList;Lorg/apache/poi/poifs/property/RootProperty;I)Lorg/apache/poi/poifs/storage/BlockList;

    move-result-object v6

    .line 94
    .local v6, "sbat":Lorg/apache/poi/poifs/storage/BlockList;
    return-void
.end method
