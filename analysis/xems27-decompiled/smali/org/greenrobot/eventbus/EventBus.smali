...
.method private postSingleEventForEventType(Ljava/lang/Object;Lorg/greenrobot/eventbus/EventBus$PostingThreadState;Ljava/lang/Class;)Z
    ...
    .line 390
    .local v1, "subscriptions":Ljava/util/concurrent/CopyOnWriteArrayList;, "Ljava/util/concurrent/CopyOnWriteArrayList<Lorg/greenrobot/eventbus/Subscription;>;"
    :try_start_1
    monitor-exit p0
    :try_end_1
    ...
    invoke-direct {p0, v4, p1, v6}, Lorg/greenrobot/eventbus/EventBus;->postToSubscription(Lorg/greenrobot/eventbus/Subscription;Ljava/lang/Object;Z)V
    ...
    .line 400
    iput-object v0, p2, Lorg/greenrobot/eventbus/EventBus$PostingThreadState;->event:Ljava/lang/Object;
    ...
    .line 402
    iput-boolean v2, p2, Lorg/greenrobot/eventbus/EventBus$PostingThreadState;->canceled:Z
    ...
    .line 400
    .restart local v4    # "subscription":Lorg/greenrobot/eventbus/Subscription;
    .restart local v5    # "aborted":Z
    :catchall_0
    move-exception v3
    ...
    .line 390
    .end local v1    # "subscriptions":Ljava/util/concurrent/CopyOnWriteArrayList;, "Ljava/util/concurrent/CopyOnWriteArrayList<Lorg/greenrobot/eventbus/Subscription;>;"
    :catchall_1
    move-exception v1
    ...
    .restart local v1    # "subscriptions":Ljava/util/concurrent/CopyOnWriteArrayList;, "Ljava/util/concurrent/CopyOnWriteArrayList<Lorg/greenrobot/eventbus/Subscription;>;"
    :goto_2
    :try_start_3
    monitor-exit p0
    :try_end_3
...
.method public hasSubscriberForEvent(Ljava/lang/Class;)Z
    ...
    .line 353
    .local v3, "subscriptions":Ljava/util/concurrent/CopyOnWriteArrayList;, "Ljava/util/concurrent/CopyOnWriteArrayList<Lorg/greenrobot/eventbus/Subscription;>;"
    :try_start_1
    monitor-exit p0
    :try_end_1
    ...
    .line 348
    .end local v3    # "subscriptions":Ljava/util/concurrent/CopyOnWriteArrayList;, "Ljava/util/concurrent/CopyOnWriteArrayList<Lorg/greenrobot/eventbus/Subscription;>;"
    ...
    .restart local v3    # "subscriptions":Ljava/util/concurrent/CopyOnWriteArrayList;, "Ljava/util/concurrent/CopyOnWriteArrayList<Lorg/greenrobot/eventbus/Subscription;>;"
    :goto_1
    :try_start_2
    monitor-exit p0
    :try_end_2
...
.method public post(Ljava/lang/Object;)V
    ...
    .line 254
    :cond_1
    iput-boolean v5, v0, Lorg/greenrobot/eventbus/EventBus$PostingThreadState;->isPosting:Z

    .line 255
    iput-boolean v5, v0, Lorg/greenrobot/eventbus/EventBus$PostingThreadState;->isMainThread:Z
