...
ok(ux.includes('<stack class="play-wrap">'), 'play-wrap is stack (Vela centers like cbox)')
ok(ux.match(/\.play-wrap\s*\{[^}]*width:\s*152px/s), 'play-wrap 152px centered by col like cbox 196px')
