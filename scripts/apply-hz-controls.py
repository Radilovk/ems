...
AVATAR_NEW = """<RelativeLayout android:layout_width="0.0dip" android:layout_height="fill_parent" android:layout_weight="0.6">
            ...
            <com.isaigu.gymapp.widget.MyButton android:id="@id/hzAdd" android:background="@drawable/light_green_button_drawable_r30" android:layout_width="50.0dip" android:layout_height="50.0dip" android:layout_alignParentRight="true" android:layout_marginTop="10.0dip" android:gravity="center" android:text="+" android:textColor="@color/white_color" android:textSize="@dimen/ui_ma_text_size" android:textStyle="bold" />
            <com.isaigu.gymapp.widget.MyButton android:id="@id/hzMinus" android:background="@drawable/light_green_button_drawable_r30" android:layout_width="50.0dip" android:layout_height="50.0dip" android:layout_alignParentLeft="true" android:layout_alignParentBottom="true" android:layout_marginBottom="10.0dip" android:gravity="center" android:text="-" android:textColor="@color/white_color" android:textSize="@dimen/ui_ma_text_size" android:textStyle="bold" />
            <TextView android:textColor="@color/white_color" android:textSize="10.0sp" android:textStyle="bold" android:gravity="center" android:id="@id/hzValue" android:background="@drawable/light_green_button_drawable_r30" android:layout_width="50.0dip" android:layout_height="50.0dip" android:layout_alignParentRight="true" android:layout_centerVertical="true" android:text="80" />
            <com.isaigu.gymapp.widget.MyButton android:id="@id/setting" android:background="@mipmap/set" android:layout_width="40.0dip" android:layout_height="40.0dip" android:layout_marginRight="20.0dip" android:layout_marginBottom="20.0dip" android:layout_alignRight="@id/circleSeekBar" android:layout_alignBottom="@id/circleSeekBar" />
...
def patch_layouts() -> None:
    for layout_dir in ("layout", "layout-night"):
        for name in ("new_user_train_control_item_layout.xml", "user_train_control_item_layout.xml"):
            ...
            if 'android:layout_alignParentRight="true" android:layout_marginTop="10.0dip"' in text and "@id/hzAdd" in text:
                print(f"{layout_dir}/{name}: Hz controls already match ma badge style")
                continue
