...
<LinearLayout android:orientation="vertical" android:paddingLeft="14.0dip" android:paddingTop="12.0dip" android:paddingRight="14.0dip" android:paddingBottom="12.0dip" android:layout_width="fill_parent" android:layout_height="wrap_content">
    <LinearLayout android:gravity="center_vertical" android:orientation="horizontal" android:layout_width="fill_parent" android:layout_height="wrap_content">
        ...
        <TextView android:textSize="11.0sp" android:textColor="@color/light_green_color" android:gravity="end" android:id="@id/intervalTimerStatus" android:layout_width="wrap_content" android:layout_height="wrap_content" android:maxWidth="110.0dip" android:maxLines="2" android:ellipsize="end" android:text="@string/interval_timer_status_idle" />
    </LinearLayout>
    <LinearLayout android:orientation="horizontal" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="10.0dip">
        <com.isaigu.gymapp.widget.MyButton android:textSize="12.0sp" android:textColor="@color/white_color" android:id="@id/intervalTimerTabInterval" android:background="@drawable/light_green_button_drawable_r30" android:layout_width="0.0dip" android:layout_height="36.0dip" android:layout_weight="1.0" android:text="@string/interval_timer_tab_interval" android:textAllCaps="false" />
        <com.isaigu.gymapp.widget.MyButton android:textSize="12.0sp" android:textColor="@color/text_primary" android:id="@id/intervalTimerTabBlock" android:background="@drawable/light_yellow_button_drawable_r30" android:layout_width="0.0dip" android:layout_height="36.0dip" android:layout_weight="1.0" android:layout_marginLeft="6.0dip" android:text="@string/interval_timer_tab_block" android:textAllCaps="false" />
    </LinearLayout>
    <LinearLayout android:orientation="vertical" android:id="@id/intervalTimerDurationRow" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="10.0dip">
        <LinearLayout android:gravity="center_vertical" android:orientation="horizontal" android:layout_width="fill_parent" android:layout_height="wrap_content">
            <TextView android:textSize="12.0sp" android:textColor="@color/text_secondary" android:id="@id/intervalTimerDurationLabel" android:layout_width="0.0dip" android:layout_height="wrap_content" android:layout_weight="1.0" android:text="@string/interval_timer_duration" />
            <TextView android:textSize="22.0sp" android:textStyle="bold" android:textColor="@color/impulse_accent" android:id="@id/intervalTimerDurationValue" android:layout_width="wrap_content" android:layout_height="wrap_content" android:text="00:30" />
        </LinearLayout>
        <SeekBar android:id="@id/intervalTimerDurationSlider" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="4.0dip" android:max="119" android:progress="5" />
    </LinearLayout>
    <LinearLayout android:orientation="vertical" android:id="@id/intervalTimerSimplePanel" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="8.0dip">
        <LinearLayout android:gravity="center_vertical" android:orientation="horizontal" android:layout_width="fill_parent" android:layout_height="wrap_content">
            <TextView android:textSize="12.0sp" android:textColor="@color/text_secondary" android:layout_width="0.0dip" android:layout_height="wrap_content" android:layout_weight="1.0" android:text="@string/interval_timer_repeats" />
            <TextView android:textSize="16.0sp" android:textStyle="bold" android:textColor="@color/text_primary" android:id="@id/intervalTimerLoopsValue" android:layout_width="wrap_content" android:layout_height="wrap_content" android:text="0" />
        </LinearLayout>
        <SeekBar android:id="@id/intervalTimerLoopsSlider" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="4.0dip" android:max="30" android:progress="0" />
        <TextView android:textSize="10.0sp" android:textColor="@color/text_secondary" android:gravity="end" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="2.0dip" android:text="@string/interval_timer_loops_hint" />
    </LinearLayout>
    <LinearLayout android:orientation="vertical" android:id="@id/intervalTimerBlockPanel" android:visibility="gone" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="8.0dip">
        ...
        <LinearLayout android:gravity="center_vertical" android:orientation="horizontal" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="6.0dip">
            <LinearLayout android:orientation="vertical" android:layout_width="0.0dip" android:layout_height="wrap_content" android:layout_weight="1.0">
                <TextView android:textSize="12.0sp" android:textColor="@color/text_primary" android:id="@id/intervalTimerBlockSummary" android:layout_width="fill_parent" android:layout_height="wrap_content" android:text="@string/segment_program_summary" />
                <TextView android:textSize="10.0sp" android:textColor="@color/light_green_color" android:id="@id/intervalTimerBlockDuration" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="2.0dip" android:text="@string/block_program_duration" />
            </LinearLayout>
            <com.isaigu.gymapp.widget.MyButton android:textSize="12.0sp" android:textColor="@color/text_primary" android:id="@id/intervalTimerBlockEdit" android:background="@drawable/light_yellow_button_drawable_r30" android:layout_width="wrap_content" android:layout_height="32.0dip" android:layout_marginLeft="6.0dip" android:minWidth="0.0dip" android:paddingLeft="10.0dip" android:paddingRight="10.0dip" android:text="@string/segment_program_edit" android:textAllCaps="false" />
        </LinearLayout>
    </LinearLayout>
    <com.isaigu.gymapp.widget.MyButton android:textSize="12.0sp" android:textColor="@color/text_secondary" android:gravity="start|center_vertical" android:id="@id/intervalTimerAdvancedToggle" android:background="@android:color/transparent" android:layout_width="fill_parent" android:layout_height="32.0dip" android:layout_marginTop="8.0dip" android:paddingLeft="0.0dip" android:paddingRight="0.0dip" android:text="@string/interval_timer_advanced" android:textAllCaps="false" />
    <LinearLayout android:orientation="vertical" android:id="@id/intervalTimerAdvancedPanel" android:visibility="gone" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="4.0dip">
        ...
        <LinearLayout android:gravity="center" android:orientation="horizontal" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="6.0dip">
            <com.isaigu.gymapp.widget.MyButton android:textSize="11.0sp" android:textColor="@color/text_primary" android:id="@id/intervalTimerPresetSave" android:background="@drawable/light_yellow_button_drawable_r30" android:layout_width="0.0dip" android:layout_height="32.0dip" android:layout_weight="1.0" android:text="@string/timer_preset_save" android:textAllCaps="false" />
            <com.isaigu.gymapp.widget.MyButton android:textSize="11.0sp" android:textColor="@color/text_primary" android:id="@id/intervalTimerPresetEdit" android:background="@drawable/light_yellow_button_drawable_r30" android:layout_width="0.0dip" android:layout_height="32.0dip" android:layout_weight="1.0" android:layout_marginLeft="4.0dip" android:text="@string/timer_preset_rename" android:textAllCaps="false" />
            <com.isaigu.gymapp.widget.MyButton android:textSize="11.0sp" android:textColor="@color/text_primary" android:id="@id/intervalTimerPresetDelete" android:background="@drawable/light_yellow_button_drawable_r30" android:layout_width="0.0dip" android:layout_height="32.0dip" android:layout_weight="1.0" android:layout_marginLeft="4.0dip" android:text="@string/timer_preset_delete" android:textAllCaps="false" />
        </LinearLayout>
