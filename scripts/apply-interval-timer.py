...
<ScrollView android:id="@id/intervalTimerConfigScroll" android:background="@drawable/modal_dialog_panel" android:scrollbars="vertical" android:layout_width="300.0dip" android:layout_height="wrap_content"
  xmlns:android="http://schemas.android.com/apk/res/android">
<LinearLayout android:orientation="vertical" android:paddingLeft="12.0dip" android:paddingTop="10.0dip" android:paddingRight="12.0dip" android:paddingBottom="10.0dip" android:layout_width="fill_parent" android:layout_height="wrap_content">
    <LinearLayout android:gravity="center_vertical" android:orientation="horizontal" android:layout_width="fill_parent" android:layout_height="wrap_content">
        <TextView android:textSize="15.0sp" android:textStyle="bold" android:textColor="@color/text_primary" android:layout_width="wrap_content" android:layout_height="wrap_content" android:text="@string/interval_timer_title" />
        <TextView android:textSize="12.0sp" android:textColor="@color/light_green_color" android:gravity="end" android:id="@id/intervalTimerStatus" android:layout_width="0.0dip" android:layout_height="wrap_content" android:layout_weight="1.0" android:layout_marginLeft="8.0dip" android:maxLines="2" android:ellipsize="end" android:text="@string/interval_timer_status_idle" />
    </LinearLayout>
    <LinearLayout android:gravity="start" android:orientation="horizontal" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="8.0dip">
        <com.isaigu.gymapp.widget.MyButton android:textSize="14.0sp" android:textColor="@color/white_color" android:gravity="center" android:id="@id/intervalTimerTabInterval" android:background="@drawable/light_green_button_drawable_r30" android:layout_width="wrap_content" android:layout_height="40.0dip" android:minWidth="0.0dip" android:paddingLeft="14.0dip" android:paddingRight="14.0dip" android:text="@string/interval_timer_tab_interval" android:textAllCaps="false" />
        <com.isaigu.gymapp.widget.MyButton android:textSize="14.0sp" android:textColor="@color/text_primary" android:gravity="center" android:id="@id/intervalTimerTabBlock" android:background="@drawable/light_yellow_button_drawable_r30" android:layout_width="wrap_content" android:layout_height="40.0dip" android:layout_marginLeft="8.0dip" android:minWidth="0.0dip" android:paddingLeft="14.0dip" android:paddingRight="14.0dip" android:text="@string/interval_timer_tab_block" android:textAllCaps="false" />
    </LinearLayout>
    <LinearLayout android:orientation="vertical" android:id="@id/intervalTimerDurationRow" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="8.0dip">
        <TextView android:textSize="13.0sp" android:textColor="@color/text_secondary" android:id="@id/intervalTimerDurationLabel" android:layout_width="wrap_content" android:layout_height="wrap_content" android:text="@string/interval_timer_duration" />
        <LinearLayout android:gravity="center_vertical|start" android:orientation="horizontal" android:layout_width="wrap_content" android:layout_height="wrap_content" android:layout_marginTop="4.0dip">
            <TextView android:textSize="13.0sp" android:textColor="@color/text_primary" android:layout_width="wrap_content" android:layout_height="wrap_content" android:text="@string/interval_timer_minutes" />
            <com.isaigu.gymapp.widget.AmountView android:id="@id/intervalTimerMinutes" android:layout_width="wrap_content" android:layout_height="wrap_content" android:layout_marginLeft="4.0dip" />
            <TextView android:textSize="13.0sp" android:textColor="@color/text_primary" android:layout_width="wrap_content" android:layout_height="wrap_content" android:layout_marginLeft="10.0dip" android:text="@string/interval_timer_seconds" />
            <com.isaigu.gymapp.widget.AmountView android:id="@id/intervalTimerSeconds" android:layout_width="wrap_content" android:layout_height="wrap_content" android:layout_marginLeft="4.0dip" />
        </LinearLayout>
    </LinearLayout>
    <LinearLayout android:orientation="vertical" android:id="@id/intervalTimerSimplePanel" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="6.0dip">
        <LinearLayout android:gravity="center_vertical|start" android:orientation="horizontal" android:layout_width="wrap_content" android:layout_height="wrap_content">
            <TextView android:textSize="13.0sp" android:textColor="@color/text_secondary" android:layout_width="wrap_content" android:layout_height="wrap_content" android:text="@string/interval_timer_repeats" />
            <com.isaigu.gymapp.widget.AmountView android:id="@id/intervalTimerLoops" android:layout_width="wrap_content" android:layout_height="wrap_content" android:layout_marginLeft="8.0dip" />
        </LinearLayout>
    ...
    <LinearLayout android:orientation="vertical" android:id="@id/intervalTimerBlockPanel" android:visibility="gone" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="6.0dip">
        <LinearLayout android:gravity="center_vertical" android:orientation="horizontal" android:layout_width="fill_parent" android:layout_height="wrap_content">
            <TextView android:textSize="13.0sp" android:textColor="@color/text_secondary" android:layout_width="0.0dip" android:layout_height="wrap_content" android:layout_weight="1.0" android:text="@string/block_program_repeat" />
        ...
        <LinearLayout android:gravity="center_vertical" android:orientation="horizontal" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="4.0dip">
            <LinearLayout android:orientation="vertical" android:layout_width="0.0dip" android:layout_height="wrap_content" android:layout_weight="1.0">
                <TextView android:textSize="13.0sp" android:textColor="@color/text_primary" android:id="@id/intervalTimerBlockSummary" android:layout_width="fill_parent" android:layout_height="wrap_content" android:text="@string/segment_program_summary" />
                <TextView android:textSize="11.0sp" android:textColor="@color/light_green_color" android:id="@id/intervalTimerBlockDuration" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="2.0dip" android:text="@string/block_program_duration" />
            </LinearLayout>
            <com.isaigu.gymapp.widget.MyButton android:textSize="13.0sp" android:textColor="@color/text_primary" android:gravity="center" android:id="@id/intervalTimerBlockEdit" android:background="@drawable/light_yellow_button_drawable_r30" android:layout_width="wrap_content" android:layout_height="34.0dip" android:layout_marginLeft="6.0dip" android:minWidth="0.0dip" android:paddingLeft="8.0dip" android:paddingRight="8.0dip" android:text="@string/segment_program_edit" android:textAllCaps="false" />
        </LinearLayout>
    </LinearLayout>
    <com.isaigu.gymapp.widget.MyButton android:textSize="13.0sp" android:textColor="@color/text_secondary" android:gravity="start|center_vertical" android:id="@id/intervalTimerAdvancedToggle" android:background="@android:color/transparent" android:layout_width="fill_parent" android:layout_height="32.0dip" android:layout_marginTop="4.0dip" android:paddingLeft="0.0dip" android:paddingRight="0.0dip" android:text="@string/interval_timer_advanced" android:textAllCaps="false" />
    <LinearLayout android:orientation="vertical" android:id="@id/intervalTimerAdvancedPanel" android:visibility="gone" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="2.0dip">
        <Spinner android:id="@id/intervalTimerPresetSpinner" android:background="@drawable/interval_timer_spinner_bg" android:layout_width="fill_parent" android:layout_height="38.0dip" android:popupBackground="@color/bg_card" android:spinnerMode="dropdown" />
        <LinearLayout android:gravity="start" android:orientation="horizontal" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="4.0dip">
            <com.isaigu.gymapp.widget.MyButton android:textSize="12.0sp" android:textColor="@color/text_primary" android:gravity="center" android:id="@id/intervalTimerPresetSave" android:background="@drawable/light_yellow_button_drawable_r30" android:layout_width="wrap_content" android:layout_height="34.0dip" android:minWidth="0.0dip" android:paddingLeft="10.0dip" android:paddingRight="10.0dip" android:text="@string/timer_preset_save" android:textAllCaps="false" />
            <com.isaigu.gymapp.widget.MyButton android:textSize="12.0sp" android:textColor="@color/text_primary" android:gravity="center" android:id="@id/intervalTimerPresetEdit" android:background="@drawable/light_yellow_button_drawable_r30" android:layout_width="wrap_content" android:layout_height="34.0dip" android:layout_marginLeft="6.0dip" android:minWidth="0.0dip" android:paddingLeft="10.0dip" android:paddingRight="10.0dip" android:text="@string/timer_preset_rename" android:textAllCaps="false" />
            <com.isaigu.gymapp.widget.MyButton android:textSize="12.0sp" android:textColor="@color/text_primary" android:gravity="center" android:id="@id/intervalTimerPresetDelete" android:background="@drawable/light_yellow_button_drawable_r30" android:layout_width="wrap_content" android:layout_height="34.0dip" android:layout_marginLeft="6.0dip" android:minWidth="0.0dip" android:paddingLeft="10.0dip" android:paddingRight="10.0dip" android:text="@string/timer_preset_delete" android:textAllCaps="false" />
        </LinearLayout>
        <LinearLayout android:gravity="center_vertical" android:orientation="horizontal" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="6.0dip">
            ...
            <com.isaigu.gymapp.widget.MyButton android:textSize="14.0sp" android:textColor="@color/white_color" android:gravity="center" android:id="@id/intervalTimerSoundPreview" android:background="@drawable/interval_timer_sound_chip" android:layout_width="36.0dip" android:layout_height="36.0dip" android:layout_marginLeft="4.0dip" android:text="&#9654;" android:textAllCaps="false" />
            <com.isaigu.gymapp.widget.MyButton android:textSize="14.0sp" android:textColor="@color/white_color" android:gravity="center" android:id="@id/intervalTimerSoundPick" android:background="@drawable/interval_timer_sound_chip" android:layout_width="36.0dip" android:layout_height="36.0dip" android:layout_marginLeft="4.0dip" android:text="+" android:textAllCaps="false" />
        </LinearLayout>
        <LinearLayout android:gravity="center_vertical" android:orientation="horizontal" android:id="@id/intervalTimerSoundFileRow" android:layout_width="fill_parent" android:layout_height="wrap_content" android:layout_marginTop="4.0dip" android:visibility="gone">
            ...
            <com.isaigu.gymapp.widget.MyButton android:textSize="14.0sp" android:textColor="@color/white_color" android:gravity="center" android:id="@id/intervalTimerSoundClear" android:background="@drawable/light_yellow_button_drawable_r30" android:layout_width="30.0dip" android:layout_height="30.0dip" android:layout_marginLeft="4.0dip" android:text="&#215;" android:textAllCaps="false" />
        </LinearLayout>
    </LinearLayout>
    <com.isaigu.gymapp.widget.MyButton android:textSize="14.0sp" android:textStyle="bold" android:textColor="@color/white_color" android:gravity="center" android:layout_gravity="center_horizontal" android:id="@id/intervalTimerActivate" android:background="@drawable/light_green_button_drawable_r30" android:layout_width="wrap_content" android:layout_height="44.0dip" android:layout_marginTop="10.0dip" android:minWidth="0.0dip" android:paddingLeft="22.0dip" android:paddingRight="22.0dip" android:text="@string/interval_timer_activate" android:textAllCaps="false" />
</LinearLayout>
</ScrollView>
"""
...
def main() -> int:
    ...
    print("patched layout/amount_layout.xml -> compact 96dp stepper")
