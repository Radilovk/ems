#!/usr/bin/env python3
"""Interval timer: master button, draggable dial overlay, training sync hooks (settings sheet is Java/XemsUi)."""
...
def main() -> int:
    ...
    print(f"created layout/{OVERLAY_LAYOUT_NAME} ({overlay_size:.0f}dp ring); settings sheet is built in Java (XemsUi)")
