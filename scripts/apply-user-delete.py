#!/usr/bin/env python3
"""Swipe-to-delete customers on the Users tab (local registry)."""
...
# Fixed: when mData == trainUsers (unfiltered), only remove once by object.
# Also scrub offline add/update queues.
...
.method public run()V
    ...
    const-string v5, "file_name_offline_user_data"

    invoke-static {v5, v2}, Lcom/isaigu/gymapp/utils/FileUtils;->getDataList(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Ljava/util/List;

    if-eqz v2, :cond_offline_add_done
    ...
    :cond_offline_add_done
    const-class v2, Lcom/isaigu/gymapp/bean/TrainUser;

    const-string v5, "file_name_offline_update_user_data"
    ...
    if-eqz v2, :cond_offline_update_done

    invoke-interface {v2, v3}, Ljava/util/List;->remove(Ljava/lang/Object;)Z

    move-result v6

    if-eqz v6, :cond_offline_update_done

    const-class v6, Lcom/isaigu/gymapp/bean/TrainUser;

    invoke-static {v5, v6, v2}, Lcom/isaigu/gymapp/utils/FileUtils;->saveListData(Ljava/lang/String;Ljava/lang/Class;Ljava/util/List;)V

    :cond_offline_update_done
...
def patch_strings() -> None:
    entries = {
        ...
        STRINGS_EN: '    <string name="suredeleteuser">Delete this customer?</string>\n',
        STRINGS_BG: '    <string name="suredeleteuser">Изтриване на клиента?</string>\n',
    }
...
def main() -> int:
    ...
    patch_strings()
    (FRAGMENT_DIR / "UserFragment$UserDeleteMenuCreator.smali").write_text(
        SWIPE_CREATOR.strip() + "\n", encoding="utf-8"
    )
    (FRAGMENT_DIR / "UserFragment$UserDeleteMenuClickListener.smali").write_text(
        SWIPE_CLICK.strip() + "\n", encoding="utf-8"
    )
    (FRAGMENT_DIR / "UserFragment$UserDeleteMenuClickListener$1.smali").write_text(
        SWIPE_RUN.strip() + "\n", encoding="utf-8"
    )
