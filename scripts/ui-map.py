...
def print_summary(data: dict) -> None:
    ...
    print("  1. Edit branding/design-config.yaml (see branding/DEVELOPMENT.md)")
    ...
    print("Controls catalog: branding/train-controls-map.yaml")
